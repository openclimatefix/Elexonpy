...
class BalancingServicesAdjustmentDisaggregatedApi(object):
    ...
    def get_balancing_nonbm_disbsad_details_settlementdate_settlementdate_settlement(self, settlement_date, settlement_period, **kwargs):  # noqa: E501
        ...
        >>> thread = api.get_balancing_nonbm_disbsad_details_settlementdate_settlementdate_settlement(settlement_date, settlement_period, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param date settlement_date: Format - date (as full-date in RFC3339). The settlement date to query. (required)
        :param int settlement_period: Format - int32. The settlement period to query. This should be an integer from 1-50 inclusive. (required)
        ...
        if kwargs.get('async_req'):
            return self.get_balancing_nonbm_disbsad_details_settlementdate_settlementdate_settlement_with_http_info(settlement_date, settlement_period, **kwargs)  # noqa: E501
        else:
            (data) = self.get_balancing_nonbm_disbsad_details_settlementdate_settlementdate_settlement_with_http_info(settlement_date, settlement_period, **kwargs)  # noqa: E501
            return data

    def get_balancing_nonbm_disbsad_details_settlementdate_settlementdate_settlement_with_http_info(self, settlement_date, settlement_period, **kwargs):  # noqa: E501
        """Disaggregated balancing services adjustment per settlement period (DISBSAD)  # noqa: E501

        This endpoint provides disaggregated balancing services adjustment data for a single settlement period. The  response includes all the buying and selling actions that occurred during that settlement period.                Date parameter must be provided in the exact format yyyy-MM-dd.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_balancing_nonbm_disbsad_details_settlementdate_settlementdate_settlement_with_http_info(settlement_date, settlement_period, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method get_balancing_nonbm_disbsad_details_settlementdate_settlementdate_settlement" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('settlement_date' not in params or
            ...
            raise ValueError("Missing the required parameter `settlement_date` when calling `get_balancing_nonbm_disbsad_details_settlementdate_settlementdate_settlement`")  # noqa: E501
        ...
        if ('settlement_period' not in params or
            ...
            raise ValueError("Missing the required parameter `settlement_period` when calling `get_balancing_nonbm_disbsad_details_settlementdate_settlementdate_settlement`")  # noqa: E501
    ...
    def get_balancing_nonbm_disbsad_summary_from_from_to_to(self, _from, to, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_balancing_nonbm_disbsad_summary_from_from_to_to(_from, to, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_balancing_nonbm_disbsad_summary_from_from_to_to_with_http_info(_from, to, **kwargs)  # noqa: E501
        else:
            (data) = self.get_balancing_nonbm_disbsad_summary_from_from_to_to_with_http_info(_from, to, **kwargs)  # noqa: E501
            return data

    def get_balancing_nonbm_disbsad_summary_from_from_to_to_with_http_info(self, _from, to, **kwargs):  # noqa: E501
        """Disaggregated balancing services adjustment time series (DISBSAD)  # noqa: E501

        This endpoint provides disaggregated balancing services adjustment data batched by settlement period. Each  batch in the time series contains a summary of all records for that settlement period, detailing the number of  buy and sell actions, price information and volume information.    By default, the from and to parameters filter the data by start time inclusively. If the settlementPeriodFrom or  settlementPeriodTo parameters are provided, the corresponding from or to parameter instead filters on settlement  date, allowing for searching by a combination of start time and/or settlement date & settlement period.  Note: When filtering via settlement date, from/to are treated as Dates only, with the time being ignored. For  example, 2022-06-01T00:00Z and 2022-06-01T11:11Z are both treated as the settlement date 2022-06-01.                All Dates and DateTimes should be expressed as defined within  <a href=\"https://datatracker.ietf.org/doc/html/rfc3339#section-5.6\" target=\"_blank\">RFC 3339</a>.                Some examples of date parameter combinations are shown below.                Filtering from start time to start time:                    /balancing/nonbm/disbsad/summary?from=2022-06-01T00:00Z&to=2022-07-01T00:00Z                Filtering from start time to settlement date and period:                    /balancing/nonbm/disbsad/summary?from=2022-06-01T00:00Z&to=2022-07-01T00:00Z&settlementPeriodTo=1                Filtering from settlement date and period to start time:                    /balancing/nonbm/disbsad/summary?from=2022-06-01T00:00Z&to=2022-07-01T00:00Z&settlementPeriodFrom=1                Filtering from settlement date and period to settlement date and period:                    /balancing/nonbm/disbsad/summary?from=2022-06-01T00:00Z&to=2022-07-01T00:00Z&settlementPeriodFrom=1&settlementPeriodTo=1  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_balancing_nonbm_disbsad_summary_from_from_to_to_with_http_info(_from, to, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_balancing_nonbm_disbsad_summary_from_from_to_to" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('_from' not in params or
            ...
            raise ValueError("Missing the required parameter `_from` when calling `get_balancing_nonbm_disbsad_summary_from_from_to_to`")  # noqa: E501
        # verify the required parameter 'to' is set
        if ('to' not in params or
                params['to'] is None):
            raise ValueError("Missing the required parameter `to` when calling `get_balancing_nonbm_disbsad_summary_from_from_to_to`")  # noqa: E501
