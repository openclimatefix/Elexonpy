...
import elexonpy.models
from elexonpy import rest
...
class ApiClient(object):
    ...
    def format_to_dataframe(self, query_params):
        """ Adjust query params for format pandas

        check the tuple of params. If one of the tuples is ('format', 'pandas')
        then change it to ('format', 'json')
        return
            change_to_pandas: bool. if to change as pandas later
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(elexonpy.models, klass)
