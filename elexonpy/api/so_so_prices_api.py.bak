...
class SOSOPricesApi(object):
    ...
    def get_soso_prices_from_from_to_to(self, _from, to, **kwargs):  # noqa: E501
        ...
        >>> thread = api.get_soso_prices_from_from_to_to(_from, to, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.get_soso_prices_from_from_to_to_with_http_info(_from, to, **kwargs)  # noqa: E501
        else:
            (data) = self.get_soso_prices_from_from_to_to_with_http_info(_from, to, **kwargs)  # noqa: E501
            return data

    def get_soso_prices_from_from_to_to_with_http_info(self, _from, to, **kwargs):  # noqa: E501
        """SO-SO prices (SOSO)  # noqa: E501

        This endpoint provides system operator to system operator prices data.  It can be filtered by start time.                This API endpoint has a maximum range of 24 hours.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_soso_prices_from_from_to_to_with_http_info(_from, to, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method get_soso_prices_from_from_to_to" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('_from' not in params or
            ...
            raise ValueError("Missing the required parameter `_from` when calling `get_soso_prices_from_from_to_to`")  # noqa: E501
        # verify the required parameter 'to' is set
        if ('to' not in params or
                params['to'] is None):
            raise ValueError("Missing the required parameter `to` when calling `get_soso_prices_from_from_to_to`")  # noqa: E501
