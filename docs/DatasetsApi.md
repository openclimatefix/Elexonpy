...
[**get_datasets_ccm_publishdatetimefrom_publishdatetimefrom_publishdatetimeto_p**](DatasetsApi.md#get_datasets_ccm_publishdatetimefrom_publishdatetimefrom_publishdatetimeto_p) | **GET** /datasets/CCM | Cost of Congestion Management (CCM / B1330)
...
[**get_datasets_igca_stream_publishdatetimefrom_publishdatetimefrom_publishdate**](DatasetsApi.md#get_datasets_igca_stream_publishdatetimefrom_publishdatetimefrom_publishdate) | **GET** /datasets/IGCA/stream | Installed Generation Capacity Aggregated (IGCA / B1410) stream
...
[**get_datasets_mid_stream_from_from_to_to**](DatasetsApi.md#get_datasets_mid_stream_from_from_to_to) | **GET** /datasets/MID/stream | Market Index Data (MID) stream
...
[**get_datasets_ocnmfd_stream**](DatasetsApi.md#get_datasets_ocnmfd_stream) | **GET** /datasets/OCNMFD/stream | 2-14 days ahead demand surplus forecast (OCNMFD) stream
...
[**get_datasets_syswarn**](DatasetsApi.md#get_datasets_syswarn) | **GET** /datasets/SYSWARN | System warnings (SYSWARN)
...
# **get_datasets_abuc_publishdatetimefrom_publishdatetimefrom_publishdatetimeto**
...
try:
    # Day-Ahead Total Load Forecast Per Bidding Zone (DATL / B0620)
    api_response = api_instance.get_datasets_datl_publishdatetimefrom_publishdatetimefrom_publishdatetimeto(publish_date_time_from, publish_date_time_to, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_datl_publishdatetimefrom_publishdatetimefrom_publishdatetimeto: %s\n" % e)
```
...
# **get_datasets_datl_stream_publishdatetimefrom_publishdatetimefrom_publishdate**
> list[InsightsApiModelsResponsesTransparencyDatasetRowsDayAheadTotalLoadPerBiddingZoneDatasetRow] get_datasets_datl_stream_publishdatetimefrom_publishdatetimefrom_publishdate(publish_date_time_from, publish_date_time_to)
...
try:
    # Day-Ahead Total Load Forecast Per Bidding Zone (DATL / B0620) stream
    api_response = api_instance.get_datasets_datl_stream_publishdatetimefrom_publishdatetimefrom_publishdate(publish_date_time_from, publish_date_time_to)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_datl_stream_publishdatetimefrom_publishdatetimefrom_publishdate: %s\n" % e)
```
...
# **get_datasets_dci**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesMiscDatasetRowsDemandControlInstructionDatasetRow get_datasets_dci(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, format=format)
...
try:
    # Demand control instructions (DCI)
    api_response = api_instance.get_datasets_dci(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_dci: %s\n" % e)
```
...
# **get_datasets_dci_stream**
> list[InsightsApiModelsResponsesMiscDatasetRowsDemandControlInstructionDatasetRow] get_datasets_dci_stream(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to)
...
try:
    # Demand control instructions (DCI) stream
    api_response = api_instance.get_datasets_dci_stream(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_dci_stream: %s\n" % e)
```
...
# **get_datasets_dgws_publishdatetimefrom_publishdatetimefrom_publishdatetimeto**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesTransparencyDatasetRowsDayAheadGenerationForWindAndSolarDatasetRow get_datasets_dgws_publishdatetimefrom_publishdatetimefrom_publishdatetimeto(publish_date_time_from, publish_date_time_to, format=format)
...
try:
    # Day-Ahead Generation For Wind And Solar (DGWS / B1440)
    api_response = api_instance.get_datasets_dgws_publishdatetimefrom_publishdatetimefrom_publishdatetimeto(publish_date_time_from, publish_date_time_to, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_dgws_publishdatetimefrom_publishdatetimefrom_publishdatetimeto: %s\n" % e)
```
...
# **get_datasets_dgws_stream_publishdatetimefrom_publishdatetimefrom_publishdate**
> list[InsightsApiModelsResponsesTransparencyDatasetRowsDayAheadGenerationForWindAndSolarDatasetRow] get_datasets_dgws_stream_publishdatetimefrom_publishdatetimefrom_publishdate(publish_date_time_from, publish_date_time_to)
...
try:
    # Day-Ahead Generation For Wind And Solar (DGWS / B1440) stream
    api_response = api_instance.get_datasets_dgws_stream_publishdatetimefrom_publishdatetimefrom_publishdate(publish_date_time_from, publish_date_time_to)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_dgws_stream_publishdatetimefrom_publishdatetimefrom_publishdate: %s\n" % e)
```
...
# **get_datasets_disbsad_from_from_to_to**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesBalancingDatasetRowsDisaggregatedBalancingServicesAdjustmentData get_datasets_disbsad_from_from_to_to(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, format=format)
...
try:
    # Disaggregated Balancing Services Adjustment Data (DISBSAD)
    api_response = api_instance.get_datasets_disbsad_from_from_to_to(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_disbsad_from_from_to_to: %s\n" % e)
```
...
# **get_datasets_disbsad_stream_from_from_to_to**
> list[InsightsApiModelsResponsesBalancingDatasetRowsDisaggregatedBalancingServicesAdjustmentData] get_datasets_disbsad_stream_from_from_to_to(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to)
...
try:
    # Disaggregated Balancing Services Adjustment Data (DISBSAD) stream
    api_response = api_instance.get_datasets_disbsad_stream_from_from_to_to(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_disbsad_stream_from_from_to_to: %s\n" % e)
```
...
# **get_datasets_feib_publishdatetimefrom_publishdatetimefrom_publishdatetimeto**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesTransparencyDatasetRowsFeibDatasetRow get_datasets_feib_publishdatetimefrom_publishdatetimefrom_publishdatetimeto(publish_date_time_from, publish_date_time_to, format=format)

Financial Expenses and Income for Balancing (FEIB / B1790)

This endpoint provides financial expenses and income for balancing data.    This API endpoint has a maximum range of 1 year (367 days).
...
try:
    # Financial Expenses and Income for Balancing (FEIB / B1790)
    api_response = api_instance.get_datasets_feib_publishdatetimefrom_publishdatetimefrom_publishdatetimeto(publish_date_time_from, publish_date_time_to, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_feib_publishdatetimefrom_publishdatetimefrom_publishdatetimeto: %s\n" % e)
```
...
# **get_datasets_feib_stream_publishdatetimefrom_publishdatetimefrom_publishdate**
> list[InsightsApiModelsResponsesTransparencyDatasetRowsFeibDatasetRow] get_datasets_feib_stream_publishdatetimefrom_publishdatetimefrom_publishdate(publish_date_time_from, publish_date_time_to)

Financial Expenses and Income for Balancing (FEIB / B1790) stream

This endpoint provides financial expenses and income for balancing data.    This endpoint has an optimised JSON payload and is aimed at frequent requests for the data.
...
try:
    # Financial Expenses and Income for Balancing (FEIB / B1790) stream
    api_response = api_instance.get_datasets_feib_stream_publishdatetimefrom_publishdatetimefrom_publishdate(publish_date_time_from, publish_date_time_to)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_feib_stream_publishdatetimefrom_publishdatetimefrom_publishdate: %s\n" % e)
```
...
[**list[InsightsApiModelsResponsesTransparencyDatasetRowsFeibDatasetRow]**](InsightsApiModelsResponsesTransparencyDatasetRowsFeibDatasetRow.md)
...
# **get_datasets_fou2t14d**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesGenerationDatasetRowsAvailabilityByFuelTypeDaily get_datasets_fou2t14d(fuel_type=fuel_type, publish_date=publish_date, publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, bidding_zone=bidding_zone, interconnector=interconnector, format=format)
...
publish_date_time_from = '2013-10-20T19:20:30+01:00' # datetime | Format - date-time (as date-time in RFC3339). (optional)
publish_date_time_to = '2013-10-20T19:20:30+01:00' # datetime | Format - date-time (as date-time in RFC3339). (optional)
bidding_zone = ['bidding_zone_example'] # list[str] |  (optional)
interconnector = true # bool |  (optional)
format = 'format_example' # str | Response data format. Use json/xml to include metadata. (optional)

try:
    # 2 to 14 days ahead generation availability aggregated by fuel type (FOU2T14D)
    api_response = api_instance.get_datasets_fou2t14d(fuel_type=fuel_type, publish_date=publish_date, publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, bidding_zone=bidding_zone, interconnector=interconnector, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_fou2t14d: %s\n" % e)
```
 ...
 **publish_date** | **date**| Format - date (as full-date in RFC3339). The publish date for filtering. This must be in the format yyyy-MM-dd. | [optional] 
 **publish_date_time_from** | **datetime**| Format - date-time (as date-time in RFC3339). | [optional] 
 **publish_date_time_to** | **datetime**| Format - date-time (as date-time in RFC3339). | [optional] 
 **bidding_zone** | [**list[str]**](str.md)|  | [optional] 
...
# **get_datasets_fou2t3yw**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesGenerationDatasetRowsAvailabilityByFuelTypeWeekly get_datasets_fou2t3yw(fuel_type=fuel_type, publish_date=publish_date, publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, week=week, year=year, bidding_zone=bidding_zone, interconnector=interconnector, format=format)
...
publish_date_time_from = '2013-10-20T19:20:30+01:00' # datetime | Format - date-time (as date-time in RFC3339). (optional)
publish_date_time_to = '2013-10-20T19:20:30+01:00' # datetime | Format - date-time (as date-time in RFC3339). (optional)
week = [56] # list[int] |  (optional)
year = [56] # list[int] |  (optional)
bidding_zone = ['bidding_zone_example'] # list[str] |  (optional)
interconnector = true # bool |  (optional)
format = 'format_example' # str | Response data format. Use json/xml to include metadata. (optional)
...
try:
    # 2 to 156 weeks ahead generation availability aggregated by fuel type (FOU2T3YW)
    api_response = api_instance.get_datasets_fou2t3yw(fuel_type=fuel_type, publish_date=publish_date, publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, week=week, year=year, bidding_zone=bidding_zone, interconnector=interconnector, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_fou2t3yw: %s\n" % e)
```
...
# **get_datasets_freq**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesMiscDatasetRowsSystemFrequency get_datasets_freq(measurement_date_time_from=measurement_date_time_from, measurement_date_time_to=measurement_date_time_to, format=format)
...
try:
    # System frequency (FREQ)
    api_response = api_instance.get_datasets_freq(measurement_date_time_from=measurement_date_time_from, measurement_date_time_to=measurement_date_time_to, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_freq: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **measurement_date_time_from** | **datetime**| Format - date-time (as date-time in RFC3339). | [optional] 
 **measurement_date_time_to** | **datetime**| Format - date-time (as date-time in RFC3339). | [optional] 
 **format** | **str**| Response data format. Use json/xml to include metadata. | [optional] 
...
# **get_datasets_freq_stream**
> list[InsightsApiModelsResponsesMiscDatasetRowsSystemFrequency] get_datasets_freq_stream(measurement_date_time_from=measurement_date_time_from, measurement_date_time_to=measurement_date_time_to)
...
try:
    # System frequency (FREQ) stream
    api_response = api_instance.get_datasets_freq_stream(measurement_date_time_from=measurement_date_time_from, measurement_date_time_to=measurement_date_time_to)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_freq_stream: %s\n" % e)
```
...
settlement_period = [56] # list[int] | List of Settlement Periods (optional)
fuel_type = ['fuel_type_example'] # list[str] | Fuel Type e.g. NUCLEAR (optional)
format = 'format_example' # str | Response data format. Use json/xml to include metadata. (optional)

try:
    # Half-hourly generation outturn by fuel type (FUELHH)
    api_response = api_instance.get_datasets_fuelhh(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, settlement_date_from=settlement_date_from, settlement_date_to=settlement_date_to, settlement_period=settlement_period, fuel_type=fuel_type, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_fuelhh: %s\n" % e)
```
 ...
 **settlement_period** | [**list[int]**](int.md)| List of Settlement Periods | [optional] 
 **fuel_type** | [**list[str]**](str.md)| Fuel Type e.g. NUCLEAR | [optional] 
 **format** | **str**| Response data format. Use json/xml to include metadata. | [optional] 
...
# **get_datasets_fuelhh_stream**
> list[InsightsApiModelsResponsesGenerationDatasetRowsAugmentedOutturnData] get_datasets_fuelhh_stream(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, settlement_date_from=settlement_date_from, settlement_date_to=settlement_date_to, settlement_period=settlement_period, fuel_type=fuel_type)
...
try:
    # Half-hourly generation outturn by fuel type (FUELHH) stream
    api_response = api_instance.get_datasets_fuelhh_stream(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, settlement_date_from=settlement_date_from, settlement_date_to=settlement_date_to, settlement_period=settlement_period, fuel_type=fuel_type)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_fuelhh_stream: %s\n" % e)
```
...
# **get_datasets_fuelinst**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesGenerationDatasetRowsAugmentedOutturnData get_datasets_fuelinst(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, settlement_date_from=settlement_date_from, settlement_date_to=settlement_date_to, settlement_period=settlement_period, fuel_type=fuel_type, format=format)
...
try:
    # Instantaneous generation outturn by fuel type (FUELINST)
    api_response = api_instance.get_datasets_fuelinst(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, settlement_date_from=settlement_date_from, settlement_date_to=settlement_date_to, settlement_period=settlement_period, fuel_type=fuel_type, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_fuelinst: %s\n" % e)
```
...
# **get_datasets_fuelinst_stream**
> list[InsightsApiModelsResponsesGenerationDatasetRowsAugmentedOutturnData] get_datasets_fuelinst_stream(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, settlement_date_from=settlement_date_from, settlement_date_to=settlement_date_to, settlement_period=settlement_period, fuel_type=fuel_type)
...
try:
    # Instantaneous generation outturn by fuel type (FUELINST) stream
    api_response = api_instance.get_datasets_fuelinst_stream(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, settlement_date_from=settlement_date_from, settlement_date_to=settlement_date_to, settlement_period=settlement_period, fuel_type=fuel_type)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_fuelinst_stream: %s\n" % e)
```
...
# **get_datasets_igca_publishdatetimefrom_publishdatetimefrom_publishdatetimeto**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesTransparencyDatasetRowsIgcaDatasetRow get_datasets_igca_publishdatetimefrom_publishdatetimefrom_publishdatetimeto(publish_date_time_from, publish_date_time_to, format=format)
...
try:
    # Installed Generation Capacity Aggregated (IGCA / B1410)
    api_response = api_instance.get_datasets_igca_publishdatetimefrom_publishdatetimefrom_publishdatetimeto(publish_date_time_from, publish_date_time_to, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_igca_publishdatetimefrom_publishdatetimefrom_publishdatetimeto: %s\n" % e)
```
...
# **get_datasets_igca_stream_publishdatetimefrom_publishdatetimefrom_publishdate**
> list[InsightsApiModelsResponsesTransparencyDatasetRowsIgcaDatasetRow] get_datasets_igca_stream_publishdatetimefrom_publishdatetimefrom_publishdate(publish_date_time_from, publish_date_time_to)
...
try:
    # Installed Generation Capacity Aggregated (IGCA / B1410) stream
    api_response = api_instance.get_datasets_igca_stream_publishdatetimefrom_publishdatetimefrom_publishdate(publish_date_time_from, publish_date_time_to)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_igca_stream_publishdatetimefrom_publishdatetimefrom_publishdate: %s\n" % e)
```
...
# **get_datasets_igcpu_publishdatetimefrom_publishdatetimefrom_publishdatetimeto**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesTransparencyDatasetRowsIgcpuDatasetRow get_datasets_igcpu_publishdatetimefrom_publishdatetimefrom_publishdatetimeto(publish_date_time_from, publish_date_time_to, format=format)

Installed Generation Capacity per Unit (IGCPU / B1420)

This endpoint provides information about production units (existing and planned)  with an installed generation capacity equaling to or exceeding 100 MW.                 The database was populated from a data dump lacking publishTime values,  all entries were assigned a default publishTime of 2023-01-01 00:00 during the migration.    This API endpoint provides a maximum data output range of 2 years (731 days).
...
try:
    # Installed Generation Capacity per Unit (IGCPU / B1420)
    api_response = api_instance.get_datasets_igcpu_publishdatetimefrom_publishdatetimefrom_publishdatetimeto(publish_date_time_from, publish_date_time_to, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_igcpu_publishdatetimefrom_publishdatetimefrom_publishdatetimeto: %s\n" % e)
```
...
# **get_datasets_igcpu_stream_publishdatetimefrom_publishdatetimefrom_publishdat**
> list[InsightsApiModelsResponsesTransparencyDatasetRowsIgcpuDatasetRow] get_datasets_igcpu_stream_publishdatetimefrom_publishdatetimefrom_publishdat(publish_date_time_from, publish_date_time_to)
...
try:
    # Installed Generation Capacity per Unit (IGCPU / B1420) stream
    api_response = api_instance.get_datasets_igcpu_stream_publishdatetimefrom_publishdatetimefrom_publishdat(publish_date_time_from, publish_date_time_to)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_igcpu_stream_publishdatetimefrom_publishdatetimefrom_publishdat: %s\n" % e)
```
...
[**list[InsightsApiModelsResponsesTransparencyDatasetRowsIgcpuDatasetRow]**](InsightsApiModelsResponsesTransparencyDatasetRowsIgcpuDatasetRow.md)
...
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesIndicatedForecastDatasetRowsIndicatedImbalance get_datasets_imbalngc(boundary=boundary, publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, format=format)

Day and day-ahead indicated imbalance (IMBALNGC)

This endpoint provides the indicated imbalance. Data is received by daily by midday from NGESO.  Expressed as an average MW value for each settlement period. The indicated imbalance forecast for  each period is the difference between the sum of the PNs submitted for generation BM Units (i.e.  the indicated generation), and the Transmission System Demand forecast made by the System Operator.                This API endpoint provides a maximum data output range of 1 day.
...
try:
    # Day and day-ahead indicated imbalance (IMBALNGC)
    api_response = api_instance.get_datasets_imbalngc(boundary=boundary, publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_imbalngc: %s\n" % e)
```
...
# **get_datasets_imbalngc_stream**
> list[InsightsApiModelsResponsesIndicatedForecastDatasetRowsIndicatedImbalance] get_datasets_imbalngc_stream(boundary=boundary, publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to)
...
try:
    # Day and day-ahead indicated imbalance (IMBALNGC) stream
    api_response = api_instance.get_datasets_imbalngc_stream(boundary=boundary, publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_imbalngc_stream: %s\n" % e)
```
...
# **get_datasets_inddem**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesIndicatedForecastDatasetRowsIndicatedDemand get_datasets_inddem(boundary=boundary, publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, format=format)

Day and day-ahead indicated demand (INDDEM)

This endpoint provides the indicated demand forecast for the current day and day-ahead received  from NGESO. The forecast is updated every half hour. The forecast for each period is the sum of  all the PNs submitted for BM Units which are forecast to be importing energy. Data is presented  an average MW for the settlement period.                This API endpoint provides a maximum data output range of 1 day.
...
try:
    # Day and day-ahead indicated demand (INDDEM)
    api_response = api_instance.get_datasets_inddem(boundary=boundary, publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_inddem: %s\n" % e)
```
...
# **get_datasets_inddem_stream**
> list[InsightsApiModelsResponsesIndicatedForecastDatasetRowsIndicatedDemand] get_datasets_inddem_stream(boundary=boundary, publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to)
...
try:
    # Day and day-ahead indicated demand (INDDEM) stream
    api_response = api_instance.get_datasets_inddem_stream(boundary=boundary, publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_inddem_stream: %s\n" % e)
```
...
# **get_datasets_indgen**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesIndicatedForecastDatasetRowsIndicatedGeneration get_datasets_indgen(boundary=boundary, publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, format=format)

Day and day-ahead indicated generation (INDGEN)

This endpoint provides the indicated generation received from NGESO. Data is received daily, by  midday. Expressed as an average MW value for each Settlement period. The indicated generation  forecast for each period is the sum of all the PNs submitted for BM Units which are forecast to  be exporting energy, presented as a single average MW value for the settlement period.    This API endpoint provides a maximum data output range of 1 day.
...
try:
    # Day and day-ahead indicated generation (INDGEN)
    api_response = api_instance.get_datasets_indgen(boundary=boundary, publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_indgen: %s\n" % e)
```
...
# **get_datasets_indgen_stream**
> list[InsightsApiModelsResponsesIndicatedForecastDatasetRowsIndicatedGeneration] get_datasets_indgen_stream(boundary=boundary, publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to)
...
try:
    # Day and day-ahead indicated generation (INDGEN) stream
    api_response = api_instance.get_datasets_indgen_stream(boundary=boundary, publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_indgen_stream: %s\n" % e)
```
...
# **get_datasets_indo**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesDemandOutturnDatasetRowsDemandOutturnNational get_datasets_indo(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, format=format)
...
try:
    # Initial National Demand outturn (INDO)
    api_response = api_instance.get_datasets_indo(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_indo: %s\n" % e)
```
...
# **get_datasets_indod_publishdatetimefrom_publishdatetimefrom_publishdatetimeto**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesDemandOutturnDatasetRowsIndodDatasetRow get_datasets_indod_publishdatetimefrom_publishdatetimefrom_publishdatetimeto(publish_date_time_from, publish_date_time_to, format=format)
...
try:
    # Initial National Demand outturn daily (INDOD)
    api_response = api_instance.get_datasets_indod_publishdatetimefrom_publishdatetimefrom_publishdatetimeto(publish_date_time_from, publish_date_time_to, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_indod_publishdatetimefrom_publishdatetimefrom_publishdatetimeto: %s\n" % e)
```
...
# **get_datasets_indod_stream_publishdatetimefrom_publishdatetimefrom_publishdat**
> list[InsightsApiModelsResponsesDemandOutturnDatasetRowsIndodDatasetRow] get_datasets_indod_stream_publishdatetimefrom_publishdatetimefrom_publishdat(publish_date_time_from, publish_date_time_to)
...
try:
    # Initial National Demand outturn daily (INDOD) stream
    api_response = api_instance.get_datasets_indod_stream_publishdatetimefrom_publishdatetimefrom_publishdat(publish_date_time_from, publish_date_time_to)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_indod_stream_publishdatetimefrom_publishdatetimefrom_publishdat: %s\n" % e)
```
...
# **get_datasets_itsdo**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesDemandOutturnDatasetRowsDemandOutturnTransmission get_datasets_itsdo(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, format=format)

Initial Transmission System Demand outturn (ITSDO)

The endpoint provides data showing the initial Transmission System Demand outturn.  Data is updated at 15 min intervals containing the initial demand expressed in MW.                Specific publish time filters may be supplied, otherwise this will retrieve the latest published forecast.
...
try:
    # Initial Transmission System Demand outturn (ITSDO)
    api_response = api_instance.get_datasets_itsdo(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_itsdo: %s\n" % e)
```
...
# **get_datasets_lolpdrm_publishdatetimefrom_publishdatetimefrom_publishdatetime**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesMiscDatasetRowsLossOfLoadProbabilityDeratedMarginData get_datasets_lolpdrm_publishdatetimefrom_publishdatetimefrom_publishdatetime(publish_date_time_from, publish_date_time_to, format=format)
...
try:
    # Loss of load probability and de-rated margin (LOLPDRM)
    api_response = api_instance.get_datasets_lolpdrm_publishdatetimefrom_publishdatetimefrom_publishdatetime(publish_date_time_from, publish_date_time_to, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_lolpdrm_publishdatetimefrom_publishdatetimefrom_publishdatetime: %s\n" % e)
```
...
# **get_datasets_lolpdrm_stream_publishdatetimefrom_publishdatetimefrom_publishd**
> list[InsightsApiModelsResponsesMiscDatasetRowsLossOfLoadProbabilityDeratedMarginData] get_datasets_lolpdrm_stream_publishdatetimefrom_publishdatetimefrom_publishd(publish_date_time_from, publish_date_time_to)
...
try:
    # Loss of load probability and de-rated margin (LOLPDRM)
    api_response = api_instance.get_datasets_lolpdrm_stream_publishdatetimefrom_publishdatetimefrom_publishd(publish_date_time_from, publish_date_time_to)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_lolpdrm_stream_publishdatetimefrom_publishdatetimefrom_publishd: %s\n" % e)
```
...
# **get_datasets_matl_publishdatetimefrom_publishdatetimefrom_publishdatetimeto**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesTransparencyDatasetRowsMonthAheadTotalLoadPerBiddingZoneDatasetRow get_datasets_matl_publishdatetimefrom_publishdatetimefrom_publishdatetimeto(publish_date_time_from, publish_date_time_to, format=format)
...
try:
    # Month-Ahead Total Load Forecast Per Bidding Zone (MATL / B0640)
    api_response = api_instance.get_datasets_matl_publishdatetimefrom_publishdatetimefrom_publishdatetimeto(publish_date_time_from, publish_date_time_to, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_matl_publishdatetimefrom_publishdatetimefrom_publishdatetimeto: %s\n" % e)
```
...
# **get_datasets_matl_stream_publishdatetimefrom_publishdatetimefrom_publishdate**
> list[InsightsApiModelsResponsesTransparencyDatasetRowsMonthAheadTotalLoadPerBiddingZoneDatasetRow] get_datasets_matl_stream_publishdatetimefrom_publishdatetimefrom_publishdate(publish_date_time_from, publish_date_time_to)
...
try:
    # Month-Ahead Total Load Forecast Per Bidding Zone (MATL / B0640) stream
    api_response = api_instance.get_datasets_matl_stream_publishdatetimefrom_publishdatetimefrom_publishdate(publish_date_time_from, publish_date_time_to)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_matl_stream_publishdatetimefrom_publishdatetimefrom_publishdate: %s\n" % e)
```
...
# **get_datasets_mdp_from_from_to_to**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesBalancingDynamicDatasetRowsDeliveryPeriodMaxData get_datasets_mdp_from_from_to_to(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit, format=format)
...
try:
    # Maximum Delivery Period (MDP)
    api_response = api_instance.get_datasets_mdp_from_from_to_to(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_mdp_from_from_to_to: %s\n" % e)
```
...
# **get_datasets_mdp_stream_from_from_to_to**
> list[InsightsApiModelsResponsesBalancingDynamicDatasetRowsDeliveryPeriodMaxData] get_datasets_mdp_stream_from_from_to_to(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit)
...
try:
    # Maximum Delivery Period (MDP) stream
    api_response = api_instance.get_datasets_mdp_stream_from_from_to_to(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_mdp_stream_from_from_to_to: %s\n" % e)
```
...
# **get_datasets_mdv_from_from_to_to**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesBalancingDynamicDatasetRowsDeliveryVolumeMaxData get_datasets_mdv_from_from_to_to(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit, format=format)
...
try:
    # Maximum Delivery Volume (MDV)
    api_response = api_instance.get_datasets_mdv_from_from_to_to(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_mdv_from_from_to_to: %s\n" % e)
```
...
# **get_datasets_mdv_stream_from_from_to_to**
> list[InsightsApiModelsResponsesBalancingDynamicDatasetRowsDeliveryVolumeMaxData] get_datasets_mdv_stream_from_from_to_to(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit)
...
try:
    # Maximum Delivery Volume (MDV) stream
    api_response = api_instance.get_datasets_mdv_stream_from_from_to_to(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_mdv_stream_from_from_to_to: %s\n" % e)
```
...
# **get_datasets_melngc**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesIndicatedForecastDatasetRowsIndicatedMargin get_datasets_melngc(boundary=boundary, publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, format=format)

Day and day-ahead indicated margin (MELNGC)

This endpoint provides the indicated margin. Data is received every half an hour from NGESO.  Expressed as an average MW value for each settlement period. The indicated margin forecast for  each settlement period is the difference between the sum of the MELs submitted for that period,  and the National Demand forecast made by the System Operator. The greater the value, the higher  the margin between available generation capacity and forecast demand - that is to say, the more  spare capacity there is forecast to be in the system.                This API endpoint provides a maximum data output range of 1 day.
...
try:
    # Day and day-ahead indicated margin (MELNGC)
    api_response = api_instance.get_datasets_melngc(boundary=boundary, publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_melngc: %s\n" % e)
```
...
# **get_datasets_melngc_stream**
> list[InsightsApiModelsResponsesIndicatedForecastDatasetRowsIndicatedMargin] get_datasets_melngc_stream(boundary=boundary, publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to)
...
try:
    # Day and day-ahead indicated margin (MELNGC) stream
    api_response = api_instance.get_datasets_melngc_stream(boundary=boundary, publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_melngc_stream: %s\n" % e)
```
...
# **get_datasets_mels_from_from_to_to**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesBalancingPhysicalDatasetRowsDeliveryLimitMaxData get_datasets_mels_from_from_to_to(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit, format=format)
...
try:
    # Maximum Export Limit (MELS)
    api_response = api_instance.get_datasets_mels_from_from_to_to(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_mels_from_from_to_to: %s\n" % e)
```
...
# **get_datasets_mels_stream_from_from_to_to**
> list[InsightsApiModelsResponsesBalancingPhysicalDatasetRowsDeliveryLimitMaxData] get_datasets_mels_stream_from_from_to_to(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit)
...
try:
    # Maximum Export Limit (MELS) stream
    api_response = api_instance.get_datasets_mels_stream_from_from_to_to(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_mels_stream_from_from_to_to: %s\n" % e)
```
...
# **get_datasets_metadata_latest**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesReferenceDatasetMetadataLatestRow get_datasets_metadata_latest(format=format)
...
try:
    # Returns the time when each dataset was last updated
    api_response = api_instance.get_datasets_metadata_latest(format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_metadata_latest: %s\n" % e)
```
...
# **get_datasets_mid_from_from_to_to**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesBalancingDatasetRowsMarketIndexDatasetResponse get_datasets_mid_from_from_to_to(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, data_providers=data_providers, format=format)
...
try:
    # Market Index Data (MID)
    api_response = api_instance.get_datasets_mid_from_from_to_to(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, data_providers=data_providers, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_mid_from_from_to_to: %s\n" % e)
```
...
# **get_datasets_mid_stream_from_from_to_to**
> list[InsightsApiModelsResponsesBalancingDatasetRowsMarketIndexDatasetResponse] get_datasets_mid_stream_from_from_to_to(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, data_providers=data_providers)
...
try:
    # Market Index Data (MID) stream
    api_response = api_instance.get_datasets_mid_stream_from_from_to_to(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, data_providers=data_providers)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_mid_stream_from_from_to_to: %s\n" % e)
```
...
# **get_datasets_mils_from_from_to_to**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesBalancingPhysicalDatasetRowsDeliveryLimitMaxData get_datasets_mils_from_from_to_to(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit, format=format)
...
try:
    # Maximum Import Limit (MILS)
    api_response = api_instance.get_datasets_mils_from_from_to_to(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_mils_from_from_to_to: %s\n" % e)
```
...
# **get_datasets_mils_stream_from_from_to_to**
> list[InsightsApiModelsResponsesBalancingPhysicalDatasetRowsDeliveryLimitMaxData] get_datasets_mils_stream_from_from_to_to(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit)
...
try:
    # Maximum Import Limit (MILS) stream
    api_response = api_instance.get_datasets_mils_stream_from_from_to_to(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_mils_stream_from_from_to_to: %s\n" % e)
```
...
# **get_datasets_mnzt_from_from_to_to**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesBalancingDynamicDatasetRowsDeliveryPeriodMinData get_datasets_mnzt_from_from_to_to(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit, format=format)
...
try:
    # Minimum Non-Zero Time (MNZT)
    api_response = api_instance.get_datasets_mnzt_from_from_to_to(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_mnzt_from_from_to_to: %s\n" % e)
```
...
# **get_datasets_mnzt_stream_from_from_to_to**
> list[InsightsApiModelsResponsesBalancingDynamicDatasetRowsDeliveryPeriodMinData] get_datasets_mnzt_stream_from_from_to_to(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit)
...
try:
    # Minimum Non-Zero Time (MNZT) stream
    api_response = api_instance.get_datasets_mnzt_stream_from_from_to_to(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_mnzt_stream_from_from_to_to: %s\n" % e)
```
...
# **get_datasets_mzt_from_from_to_to**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesBalancingDynamicDatasetRowsDeliveryPeriodMinData get_datasets_mzt_from_from_to_to(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit, format=format)
...
try:
    # Minimum Zero Time (MZT)
    api_response = api_instance.get_datasets_mzt_from_from_to_to(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_mzt_from_from_to_to: %s\n" % e)
```
...
# **get_datasets_mzt_stream_from_from_to_to**
> list[InsightsApiModelsResponsesBalancingDynamicDatasetRowsDeliveryPeriodMinData] get_datasets_mzt_stream_from_from_to_to(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit)
...
try:
    # Minimum Zero Time (MZT) stream
    api_response = api_instance.get_datasets_mzt_stream_from_from_to_to(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_mzt_stream_from_from_to_to: %s\n" % e)
```
...
# **get_datasets_ndf**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesDemandForecastDatasetRowsDemandForecastNationalDayAhead get_datasets_ndf(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, format=format)

Day and day-ahead National Demand forecast (NDF)

This endpoint provides the National Demand forecast received from NGESO. Data is available  daily and will show values for the day ahead. Expressed as an average MW  value for each settlement period. The forecast is based on historically metered generation  output for Great Britain. This value INCLUDES transmission losses, but EXCLUDES interconnector  flows and demand from station transformers and pumped storage units.                This API endpoint provides a maximum data output range of 1 day.                Specific publish time filters may be supplied, otherwise this will retrieve the latest published forecast.
...
try:
    # Day and day-ahead National Demand forecast (NDF)
    api_response = api_instance.get_datasets_ndf(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_ndf: %s\n" % e)
```
...
# **get_datasets_ndf_stream**
> list[InsightsApiModelsResponsesDemandForecastDatasetRowsDemandForecastNationalDayAhead] get_datasets_ndf_stream(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to)
...
try:
    # Day and day-ahead National Demand forecast (NDF) stream
    api_response = api_instance.get_datasets_ndf_stream(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_ndf_stream: %s\n" % e)
```
...
# **get_datasets_ndfd**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesDemandForecastDatasetRowsDemandForecastNationalDaily get_datasets_ndfd(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, format=format)
...
try:
    # 2-14 days ahead National Demand and surplus forecast (NDFD)
    api_response = api_instance.get_datasets_ndfd(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_ndfd: %s\n" % e)
```
...
# **get_datasets_ndfd_stream**
> list[InsightsApiModelsResponsesDemandForecastDatasetRowsDemandForecastNationalDaily] get_datasets_ndfd_stream(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to)
...
try:
    # 2-14 days ahead National Demand and surplus forecast (NDFD) stream
    api_response = api_instance.get_datasets_ndfd_stream(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_ndfd_stream: %s\n" % e)
```
...
# **get_datasets_ndfw**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesDemandForecastDatasetRowsDemandForecastNationalWeekly get_datasets_ndfw(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, format=format)
...
try:
    # 2-52 weeks ahead National Demand and surplus forecast (NDFW)
    api_response = api_instance.get_datasets_ndfw(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_ndfw: %s\n" % e)
```
...
# **get_datasets_ndfw_stream**
> list[InsightsApiModelsResponsesDemandForecastDatasetRowsDemandForecastNationalWeekly] get_datasets_ndfw_stream(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to)
...
try:
    # 2-52 weeks ahead National Demand and surplus forecast (NDFW) stream
    api_response = api_instance.get_datasets_ndfw_stream(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_ndfw_stream: %s\n" % e)
```
...
# **get_datasets_ndz_from_from_to_to**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesBalancingDynamicDatasetRowsNoticeData get_datasets_ndz_from_from_to_to(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit, format=format)
...
try:
    # Notice to Deviate from Zero (NDZ)
    api_response = api_instance.get_datasets_ndz_from_from_to_to(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_ndz_from_from_to_to: %s\n" % e)
```
...
# **get_datasets_ndz_stream_from_from_to_to**
> list[InsightsApiModelsResponsesBalancingDynamicDatasetRowsNoticeData] get_datasets_ndz_stream_from_from_to_to(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit)
...
try:
    # Notice to Deviate from Zero (NDZ) stream
    api_response = api_instance.get_datasets_ndz_stream_from_from_to_to(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_ndz_stream_from_from_to_to: %s\n" % e)
```
...
# **get_datasets_netbsad_from_from_to_to**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesBalancingDatasetRowsNetBalancingServicesAdjustmentData get_datasets_netbsad_from_from_to_to(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, format=format)
...
try:
    # Net Balancing Services Adjustment Data (NETBSAD)
    api_response = api_instance.get_datasets_netbsad_from_from_to_to(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_netbsad_from_from_to_to: %s\n" % e)
```
...
# **get_datasets_netbsad_stream_from_from_to_to**
> list[InsightsApiModelsResponsesBalancingDatasetRowsNetBalancingServicesAdjustmentData] get_datasets_netbsad_stream_from_from_to_to(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to)
...
try:
    # Net Balancing Services Adjustment Data (NETBSAD)
    api_response = api_instance.get_datasets_netbsad_stream_from_from_to_to(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_netbsad_stream_from_from_to_to: %s\n" % e)
```
...
# **get_datasets_nonbm**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesGenerationDatasetRowsNonBmStorData get_datasets_nonbm(_from=_from, to=to, format=format)
...
try:
    # Non-BM STOR (NONBM)
    api_response = api_instance.get_datasets_nonbm(_from=_from, to=to, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_nonbm: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **_from** | **datetime**| Format - date-time (as date-time in RFC3339). The start of the data publish time window. | [optional] 
 **to** | **datetime**| Format - date-time (as date-time in RFC3339). The end of the data publish time window. | [optional] 
 **format** | **str**| Response data format. Use json/xml to include metadata. | [optional] 
...
# **get_datasets_nonbm_stream**
> list[InsightsApiModelsResponsesGenerationDatasetRowsNonBmStorData] get_datasets_nonbm_stream(_from=_from, to=to)
...
try:
    # Non-BM STOR (NONBM) stream
    api_response = api_instance.get_datasets_nonbm_stream(_from=_from, to=to)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_nonbm_stream: %s\n" % e)
```
...
# **get_datasets_nou2t14d**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesGenerationDatasetRowsAvailabilityDaily get_datasets_nou2t14d(publish_date=publish_date, publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, format=format)
...
try:
    # 2 to 14 days ahead generation availability aggregated data (NOU2T14D)
    api_response = api_instance.get_datasets_nou2t14d(publish_date=publish_date, publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_nou2t14d: %s\n" % e)
```
...
# **get_datasets_nou2t3yw**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesGenerationDatasetRowsAvailabilityWeekly get_datasets_nou2t3yw(publish_date=publish_date, publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, week=week, year=year, format=format)
...
try:
    # 2 to 156 weeks ahead generation availability aggregated data (NOU2T3YW)
    api_response = api_instance.get_datasets_nou2t3yw(publish_date=publish_date, publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, week=week, year=year, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_nou2t3yw: %s\n" % e)
```
...
# **get_datasets_ntb_from_from_to_to**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesBalancingDynamicDatasetRowsNoticeData get_datasets_ntb_from_from_to_to(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit, format=format)
...
try:
    # Notice to Deliver Bids (NTB)
    api_response = api_instance.get_datasets_ntb_from_from_to_to(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_ntb_from_from_to_to: %s\n" % e)
```
...
# **get_datasets_ntb_stream_from_from_to_to**
> list[InsightsApiModelsResponsesBalancingDynamicDatasetRowsNoticeData] get_datasets_ntb_stream_from_from_to_to(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit)
...
try:
    # Notice to Deliver Bids (NTB) stream
    api_response = api_instance.get_datasets_ntb_stream_from_from_to_to(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_ntb_stream_from_from_to_to: %s\n" % e)
```
...
# **get_datasets_nto_from_from_to_to**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesBalancingDynamicDatasetRowsNoticeData get_datasets_nto_from_from_to_to(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit, format=format)
...
try:
    # Notice to Deliver Offers (NTO)
    api_response = api_instance.get_datasets_nto_from_from_to_to(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_nto_from_from_to_to: %s\n" % e)
```
...
# **get_datasets_nto_stream_from_from_to_to**
> list[InsightsApiModelsResponsesBalancingDynamicDatasetRowsNoticeData] get_datasets_nto_stream_from_from_to_to(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit)
...
try:
    # Notice to Deliver Offers (NTO) stream
    api_response = api_instance.get_datasets_nto_stream_from_from_to_to(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_nto_stream_from_from_to_to: %s\n" % e)
```
...
# **get_datasets_ocnmf3y**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesForecastSurplusDatasetRowsForecastSurplusWeekly get_datasets_ocnmf3y(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, format=format)

2-156 weeks ahead demand surplus forecast (OCNMF3Y)

The demand surplus forecast data is received hourly from NGESO.  It shows the weekly peak half hour MW value of generating plant demand surplus for each day for the 2-156 weeks ahead.    This API endpoint provides a maximum data output range of 7 days.                Specific publish time filters may be supplied, otherwise this will retrieve the latest published forecast.
...
try:
    # 2-156 weeks ahead demand surplus forecast (OCNMF3Y)
    api_response = api_instance.get_datasets_ocnmf3y(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_ocnmf3y: %s\n" % e)
```
...
# **get_datasets_ocnmf3y2**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesForecastMarginDatasetRowsForecastMarginWeekly get_datasets_ocnmf3y2(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, format=format)

2-156 weeks ahead demand margin forecast (OCNMF3Y2)

The demand margin forecast is received hourly from NGESO.  It shows the weekly peak half hour MW value of generating plant demand margin for each day for the 2 to 156 weeks ahead.                This API endpoint has a maximum data output range of 7 days.    Specific publish time filters may be supplied, otherwise this will retrieve the latest published forecast.
...
try:
    # 2-156 weeks ahead demand margin forecast (OCNMF3Y2)
    api_response = api_instance.get_datasets_ocnmf3y2(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_ocnmf3y2: %s\n" % e)
```
...
# **get_datasets_ocnmf3y2_stream**
> list[InsightsApiModelsResponsesForecastMarginDatasetRowsForecastMarginWeekly] get_datasets_ocnmf3y2_stream(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to)
...
try:
    # 2-156 weeks ahead demand margin forecast (OCNMF3Y2) stream
    api_response = api_instance.get_datasets_ocnmf3y2_stream(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_ocnmf3y2_stream: %s\n" % e)
```
...
# **get_datasets_ocnmf3y_stream**
> list[InsightsApiModelsResponsesForecastSurplusDatasetRowsForecastSurplusWeekly] get_datasets_ocnmf3y_stream(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to)
...
try:
    # 2-156 weeks ahead demand surplus forecast (OCNMF3Y) stream
    api_response = api_instance.get_datasets_ocnmf3y_stream(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_ocnmf3y_stream: %s\n" % e)
```
...
# **get_datasets_ocnmfd**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesForecastSurplusDatasetRowsForecastSurplusDaily get_datasets_ocnmfd(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, format=format)
...
try:
    # 2-14 days ahead demand surplus forecast (OCNMFD)
    api_response = api_instance.get_datasets_ocnmfd(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_ocnmfd: %s\n" % e)
```
...
# **get_datasets_ocnmfd2**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesForecastMarginDatasetRowsForecastMarginDaily get_datasets_ocnmfd2(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, format=format)
...
try:
    # 2-14 days ahead demand margin forecast (OCNMFD2)
    api_response = api_instance.get_datasets_ocnmfd2(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_ocnmfd2: %s\n" % e)
```
...
# **get_datasets_ocnmfd2_stream**
> list[InsightsApiModelsResponsesForecastMarginDatasetRowsForecastMarginDaily] get_datasets_ocnmfd2_stream(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to)
...
try:
    # 2-14 days ahead demand margin forecast (OCNMFD2) stream
    api_response = api_instance.get_datasets_ocnmfd2_stream(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_ocnmfd2_stream: %s\n" % e)
```
...
# **get_datasets_ocnmfd_stream**
> list[InsightsApiModelsResponsesForecastSurplusDatasetRowsForecastSurplusDaily] get_datasets_ocnmfd_stream(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to)
...
try:
    # 2-14 days ahead demand surplus forecast (OCNMFD) stream
    api_response = api_instance.get_datasets_ocnmfd_stream(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_ocnmfd_stream: %s\n" % e)
```
...
# **get_datasets_pbc_publishdatetimefrom_publishdatetimefrom_publishdatetimeto_p**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesTransparencyDatasetRowsPbcDatasetRow get_datasets_pbc_publishdatetimefrom_publishdatetimefrom_publishdatetimeto_p(publish_date_time_from, publish_date_time_to, format=format)

Procured Balancing Capacity (PBC)

This endpoint provides information on the procured balancing capacity, in accordance with the Electricity Balancing Guidelines (EBGL) article 12.3.f.    This API endpoint has a maximum range of 1 day.
...
try:
    # Procured Balancing Capacity (PBC)
    api_response = api_instance.get_datasets_pbc_publishdatetimefrom_publishdatetimefrom_publishdatetimeto_p(publish_date_time_from, publish_date_time_to, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_pbc_publishdatetimefrom_publishdatetimefrom_publishdatetimeto_p: %s\n" % e)
```
...
# **get_datasets_pbc_stream_publishdatetimefrom_publishdatetimefrom_publishdatet**
> list[InsightsApiModelsResponsesTransparencyDatasetRowsPbcDatasetRow] get_datasets_pbc_stream_publishdatetimefrom_publishdatetimefrom_publishdatet(publish_date_time_from, publish_date_time_to)

Procured Balancing Capacity (PBC) stream

This endpoint provides information on the procured balancing capacity, in accordance with the Electricity Balancing Guidelines (EBGL) article 12.3.f.    This endpoint has an optimised JSON payload and is aimed at frequent requests for the data.
...
try:
    # Procured Balancing Capacity (PBC) stream
    api_response = api_instance.get_datasets_pbc_stream_publishdatetimefrom_publishdatetimefrom_publishdatet(publish_date_time_from, publish_date_time_to)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_pbc_stream_publishdatetimefrom_publishdatetimefrom_publishdatet: %s\n" % e)
```
...
[**list[InsightsApiModelsResponsesTransparencyDatasetRowsPbcDatasetRow]**](InsightsApiModelsResponsesTransparencyDatasetRowsPbcDatasetRow.md)
...
# **get_datasets_pn_settlementdate_settlementdate_settlementperiod_settlementper**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesBalancingPhysicalDatasetRowsPhysicalNotificationData get_datasets_pn_settlementdate_settlementdate_settlementperiod_settlementper(settlement_date, settlement_period, bm_unit=bm_unit, format=format)
...
try:
    # Physical Notifications (PN)
    api_response = api_instance.get_datasets_pn_settlementdate_settlementdate_settlementperiod_settlementper(settlement_date, settlement_period, bm_unit=bm_unit, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_pn_settlementdate_settlementdate_settlementperiod_settlementper: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **settlement_date** | **date**| Format - date (as full-date in RFC3339). The settlement date to query. This must be in the format yyyy-MM-dd. | 
...
# **get_datasets_pn_stream_from_from_to_to**
> list[InsightsApiModelsResponsesBalancingPhysicalDatasetRowsPhysicalNotificationData] get_datasets_pn_stream_from_from_to_to(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit)
...
try:
    # Physical Notifications (PN) stream
    api_response = api_instance.get_datasets_pn_stream_from_from_to_to(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_pn_stream_from_from_to_to: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **_from** | **datetime**| Format - date-time (as date-time in RFC3339). The settlement date to query from. | 
 **to** | **datetime**| Format - date-time (as date-time in RFC3339). The settlement date to query up to. | 
 **settlement_period_from** | **int**| Format - int32. The \&quot;from\&quot; settlement period for the filter. This should be an integer from 1-50 inclusive. | [optional] 
 **settlement_period_to** | **int**| Format - int32. The \&quot;to\&quot; settlement period for the filter. This should be an integer from 1-50 inclusive. | [optional] 
 **bm_unit** | [**list[str]**](str.md)| The BM units to query. Add each unit separately. If no BM unit is selected all BM units will be displayed. | [optional] 
...
# **get_datasets_ppbr_publishdatetimefrom_publishdatetimefrom_publishdatetimeto**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesTransparencyDatasetRowsPpbrDatasetRow get_datasets_ppbr_publishdatetimefrom_publishdatetimefrom_publishdatetimeto(publish_date_time_from, publish_date_time_to, format=format)

Prices Of Procured Balancing Reserves (PPBR / B1730)

This endpoint provides prices of procured balancing reserves.    This API endpoint has a maximum range of 2 years (731 days).
...
try:
    # Prices Of Procured Balancing Reserves (PPBR / B1730)
    api_response = api_instance.get_datasets_ppbr_publishdatetimefrom_publishdatetimefrom_publishdatetimeto(publish_date_time_from, publish_date_time_to, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_ppbr_publishdatetimefrom_publishdatetimefrom_publishdatetimeto: %s\n" % e)
```
...
# **get_datasets_ppbr_stream_publishdatetimefrom_publishdatetimefrom_publishdate**
> list[InsightsApiModelsResponsesTransparencyDatasetRowsPpbrDatasetRow] get_datasets_ppbr_stream_publishdatetimefrom_publishdatetimefrom_publishdate(publish_date_time_from, publish_date_time_to)

Prices Of Procured Balancing Reserves (PPBR / B1730) stream

This endpoint provides prices of procured balancing reserves.    This endpoint has an optimised JSON payload and is aimed at frequent requests for the data.
...
try:
    # Prices Of Procured Balancing Reserves (PPBR / B1730) stream
    api_response = api_instance.get_datasets_ppbr_stream_publishdatetimefrom_publishdatetimefrom_publishdate(publish_date_time_from, publish_date_time_to)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_ppbr_stream_publishdatetimefrom_publishdatetimefrom_publishdate: %s\n" % e)
```
...
[**list[InsightsApiModelsResponsesTransparencyDatasetRowsPpbrDatasetRow]**](InsightsApiModelsResponsesTransparencyDatasetRowsPpbrDatasetRow.md)
...
# **get_datasets_qas_from_from_to_to**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesBalancingDatasetRowsBalancingServicesVolumeData get_datasets_qas_from_from_to_to(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit, format=format)
...
try:
    # Balancing Services Volume (QAS)
    api_response = api_instance.get_datasets_qas_from_from_to_to(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_qas_from_from_to_to: %s\n" % e)
```
...
# **get_datasets_qas_stream_from_from_to_to**
> list[InsightsApiModelsResponsesBalancingDatasetRowsBalancingServicesVolumeData] get_datasets_qas_stream_from_from_to_to(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit)
...
try:
    # Balancing Services Volume (QAS) stream
    api_response = api_instance.get_datasets_qas_stream_from_from_to_to(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_qas_stream_from_from_to_to: %s\n" % e)
```
...
# **get_datasets_qpn_settlementdate_settlementdate_settlementperiod_settlementpe**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesBalancingPhysicalDatasetRowsPhysicalNotificationData get_datasets_qpn_settlementdate_settlementdate_settlementperiod_settlementpe(settlement_date, settlement_period, bm_unit=bm_unit, format=format)
...
try:
    # Quiescent Physical Notifications (QPN)
    api_response = api_instance.get_datasets_qpn_settlementdate_settlementdate_settlementperiod_settlementpe(settlement_date, settlement_period, bm_unit=bm_unit, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_qpn_settlementdate_settlementdate_settlementperiod_settlementpe: %s\n" % e)
```
...
# **get_datasets_qpn_stream_from_from_to_to**
> list[InsightsApiModelsResponsesBalancingPhysicalDatasetRowsPhysicalNotificationData] get_datasets_qpn_stream_from_from_to_to(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit)
...
try:
    # Quiescent Physical Notifications (QPN) stream
    api_response = api_instance.get_datasets_qpn_stream_from_from_to_to(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_qpn_stream_from_from_to_to: %s\n" % e)
```
...
# **get_datasets_rdre_from_from_to_to**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesBalancingDynamicRateData get_datasets_rdre_from_from_to_to(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit, format=format)
...
try:
    # Run Down Rate Export (RDRE)
    api_response = api_instance.get_datasets_rdre_from_from_to_to(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_rdre_from_from_to_to: %s\n" % e)
```
...
# **get_datasets_rdre_stream_from_from_to_to**
> list[InsightsApiModelsResponsesBalancingDynamicRateData] get_datasets_rdre_stream_from_from_to_to(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit)
...
try:
    # Run Down Rate Export (RDRE) stream
    api_response = api_instance.get_datasets_rdre_stream_from_from_to_to(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_rdre_stream_from_from_to_to: %s\n" % e)
```
...
# **get_datasets_rdri_from_from_to_to**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesBalancingDynamicRateData get_datasets_rdri_from_from_to_to(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit, format=format)
...
try:
    # Run Down Rate Import (RDRI)
    api_response = api_instance.get_datasets_rdri_from_from_to_to(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_rdri_from_from_to_to: %s\n" % e)
```
...
# **get_datasets_rdri_stream_from_from_to_to**
> list[InsightsApiModelsResponsesBalancingDynamicRateData] get_datasets_rdri_stream_from_from_to_to(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit)
...
try:
    # Run Down Rate Import (RDRI) stream
    api_response = api_instance.get_datasets_rdri_stream_from_from_to_to(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_rdri_stream_from_from_to_to: %s\n" % e)
```
...
# **get_datasets_remit_publishdatetimefrom_publishdatetimefrom_publishdatetimeto**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesTransparencyRemitDatasetRowsRemitMessage get_datasets_remit_publishdatetimefrom_publishdatetimefrom_publishdatetimeto(publish_date_time_from, publish_date_time_to, format=format)
...
try:
    # The Regulation on Wholesale Energy Markets Integrity and Transparency (REMIT)
    api_response = api_instance.get_datasets_remit_publishdatetimefrom_publishdatetimefrom_publishdatetimeto(publish_date_time_from, publish_date_time_to, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_remit_publishdatetimefrom_publishdatetimefrom_publishdatetimeto: %s\n" % e)
```
...
# **get_datasets_remit_stream_publishdatetimefrom_publishdatetimefrom_publishdat**
> list[InsightsApiModelsResponsesTransparencyRemitDatasetRowsRemitMessage] get_datasets_remit_stream_publishdatetimefrom_publishdatetimefrom_publishdat(publish_date_time_from, publish_date_time_to)
...
try:
    # The Regulation on Wholesale Energy Markets Integrity and Transparency (REMIT) stream
    api_response = api_instance.get_datasets_remit_stream_publishdatetimefrom_publishdatetimefrom_publishdat(publish_date_time_from, publish_date_time_to)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_remit_stream_publishdatetimefrom_publishdatetimefrom_publishdat: %s\n" % e)
```
...
# **get_datasets_rure_from_from_to_to**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesBalancingDynamicRateData get_datasets_rure_from_from_to_to(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit, format=format)
...
try:
    # Run Up Rate Export (RURE)
    api_response = api_instance.get_datasets_rure_from_from_to_to(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_rure_from_from_to_to: %s\n" % e)
```
...
# **get_datasets_rure_stream_from_from_to_to**
> list[InsightsApiModelsResponsesBalancingDynamicRateData] get_datasets_rure_stream_from_from_to_to(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit)
...
try:
    # Run Up Rate Export (RURE) stream
    api_response = api_instance.get_datasets_rure_stream_from_from_to_to(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_rure_stream_from_from_to_to: %s\n" % e)
```
...
# **get_datasets_ruri_from_from_to_to**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesBalancingDynamicRateData get_datasets_ruri_from_from_to_to(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit, format=format)
...
try:
    # Run Up Rate Import (RURI)
    api_response = api_instance.get_datasets_ruri_from_from_to_to(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_ruri_from_from_to_to: %s\n" % e)
```
...
# **get_datasets_ruri_stream_from_from_to_to**
> list[InsightsApiModelsResponsesBalancingDynamicRateData] get_datasets_ruri_stream_from_from_to_to(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit)
...
try:
    # Run Up Rate Import (RURI) stream
    api_response = api_instance.get_datasets_ruri_stream_from_from_to_to(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_ruri_stream_from_from_to_to: %s\n" % e)
```
...
# **get_datasets_sel**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesBalancingDynamicDatasetRowsStablePortageLimitData get_datasets_sel(_from=_from, to=to, bm_unit=bm_unit, format=format)
...
try:
    # Stable Export Limit (SEL)
    api_response = api_instance.get_datasets_sel(_from=_from, to=to, bm_unit=bm_unit, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_sel: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **_from** | **datetime**| Format - date-time (as date-time in RFC3339). The start of the data time window. | [optional] 
 **to** | **datetime**| Format - date-time (as date-time in RFC3339). The end of the data time window. | [optional] 
 **bm_unit** | [**list[str]**](str.md)| The BM units to query. Add each unit separately. If no BM unit is selected all BM units will be displayed. | [optional] 
 **format** | **str**| Response data format. Use json/xml to include metadata. | [optional] 
...
# **get_datasets_sel_stream**
> list[InsightsApiModelsResponsesBalancingDynamicDatasetRowsStablePortageLimitData] get_datasets_sel_stream(_from=_from, to=to, bm_unit=bm_unit)
...
try:
    # Stable Export Limit (SEL) stream
    api_response = api_instance.get_datasets_sel_stream(_from=_from, to=to, bm_unit=bm_unit)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_sel_stream: %s\n" % e)
```
...
# **get_datasets_sil**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesBalancingDynamicDatasetRowsStablePortageLimitData get_datasets_sil(_from=_from, to=to, bm_unit=bm_unit, format=format)
...
try:
    # Stable Import Limit (SIL)
    api_response = api_instance.get_datasets_sil(_from=_from, to=to, bm_unit=bm_unit, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_sil: %s\n" % e)
```
...
# **get_datasets_sil_stream**
> list[InsightsApiModelsResponsesBalancingDynamicDatasetRowsStablePortageLimitData] get_datasets_sil_stream(_from=_from, to=to, bm_unit=bm_unit)
...
try:
    # Stable Import Limit (SIL) stream
    api_response = api_instance.get_datasets_sil_stream(_from=_from, to=to, bm_unit=bm_unit)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_sil_stream: %s\n" % e)
```
...
# **get_datasets_soso_publishdatetimefrom_publishdatetimefrom_publishdatetimeto**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesMiscDatasetRowsSoSoPricesDatasetRow get_datasets_soso_publishdatetimefrom_publishdatetimefrom_publishdatetimeto(publish_date_time_from, publish_date_time_to, format=format)

SO-SO prices (SOSO)

This endpoint provides system operator to system operator prices data, filtered by publish time.  This API endpoint has a maximum range of 24 hours.
...
try:
    # SO-SO prices (SOSO)
    api_response = api_instance.get_datasets_soso_publishdatetimefrom_publishdatetimefrom_publishdatetimeto(publish_date_time_from, publish_date_time_to, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_soso_publishdatetimefrom_publishdatetimefrom_publishdatetimeto: %s\n" % e)
```
...
# **get_datasets_soso_stream_publishdatetimefrom_publishdatetimefrom_publishdate**
> list[InsightsApiModelsResponsesMiscDatasetRowsSoSoPricesDatasetRow] get_datasets_soso_stream_publishdatetimefrom_publishdatetimefrom_publishdate(publish_date_time_from, publish_date_time_to)

SO-SO prices (SOSO) stream

This endpoint provides system operator to system operator prices data, filtered by publish time.    This endpoint has an optimised JSON payload and is aimed at frequent requests for the data.
...
try:
    # SO-SO prices (SOSO) stream
    api_response = api_instance.get_datasets_soso_stream_publishdatetimefrom_publishdatetimefrom_publishdate(publish_date_time_from, publish_date_time_to)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_soso_stream_publishdatetimefrom_publishdatetimefrom_publishdate: %s\n" % e)
```
...
[**list[InsightsApiModelsResponsesMiscDatasetRowsSoSoPricesDatasetRow]**](InsightsApiModelsResponsesMiscDatasetRowsSoSoPricesDatasetRow.md)
...
# **get_datasets_syswarn**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesMiscDatasetRowsSystemWarningsData get_datasets_syswarn(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, format=format)
...
try:
    # System warnings (SYSWARN)
    api_response = api_instance.get_datasets_syswarn(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_syswarn: %s\n" % e)
```
...
# **get_datasets_syswarn_stream**
> list[InsightsApiModelsResponsesMiscDatasetRowsSystemWarningsData] get_datasets_syswarn_stream(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to)

System warnings (SYSWARN) stream

This endpoint provides system warnings data    This endpoint has an optimised JSON payload and is aimed at frequent requests for the data.
...
try:
    # System warnings (SYSWARN) stream
    api_response = api_instance.get_datasets_syswarn_stream(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_syswarn_stream: %s\n" % e)
```
...
# **get_datasets_temp**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesMiscDatasetRowsTemperatureData get_datasets_temp(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, format=format)
...
try:
    # Temperature data (TEMP)
    api_response = api_instance.get_datasets_temp(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_temp: %s\n" % e)
```
...
# **get_datasets_tsdf**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesDemandForecastDatasetRowsDemandForecastTransmissionDayAhead get_datasets_tsdf(boundary=boundary, publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, format=format)

Day and day-ahead Transmission System Demand forecast (TSDF)

This endpoint provides the Transmission System Demand forecast.  Data is received daily from NGESO and will show values for the day ahead.  Expressed as an average MW value for each settlement period.  The Transmission System Demand forecast is based on historically metered generation output for Great Britain.  This value INCLUDES interconnector flows and demand from station transformers and pumped storage units.    Specific publish time filters may be supplied, otherwise this will retrieve the latest published forecast.                This API endpoint provides a maximum data output range of 1 day.
...
try:
    # Day and day-ahead Transmission System Demand forecast (TSDF)
    api_response = api_instance.get_datasets_tsdf(boundary=boundary, publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_tsdf: %s\n" % e)
```
...
# **get_datasets_tsdf_stream**
> list[InsightsApiModelsResponsesDemandForecastDatasetRowsDemandForecastTransmissionDayAhead] get_datasets_tsdf_stream(boundary=boundary, publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to)
...
try:
    # Day and day-ahead Transmission System Demand forecast (TSDF) stream
    api_response = api_instance.get_datasets_tsdf_stream(boundary=boundary, publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_tsdf_stream: %s\n" % e)
```
...
# **get_datasets_tsdfd**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesDemandForecastDatasetRowsDemandForecastTransmissionDaily get_datasets_tsdfd(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, format=format)
...
try:
    # 2-14 days ahead Transmission System Demand and surplus forecast (TSDFD)
    api_response = api_instance.get_datasets_tsdfd(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_tsdfd: %s\n" % e)
```
...
# **get_datasets_tsdfd_stream**
> list[InsightsApiModelsResponsesDemandForecastDatasetRowsDemandForecastTransmissionDaily] get_datasets_tsdfd_stream(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to)
...
try:
    # 2-14 days ahead Transmission System Demand and surplus forecast (TSDFD) stream
    api_response = api_instance.get_datasets_tsdfd_stream(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_tsdfd_stream: %s\n" % e)
```
...
# **get_datasets_tsdfw**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesDemandForecastDatasetRowsDemandForecastTransmissionWeekly get_datasets_tsdfw(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, format=format)
...
try:
    # 2-52 weeks ahead Transmission System Demand and surplus forecast (TSDFW)
    api_response = api_instance.get_datasets_tsdfw(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_tsdfw: %s\n" % e)
```
...
# **get_datasets_tsdfw_stream**
> list[InsightsApiModelsResponsesDemandForecastDatasetRowsDemandForecastTransmissionWeekly] get_datasets_tsdfw_stream(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to)
...
try:
    # 2-52 weeks ahead Transmission System Demand and surplus forecast (TSDFW) stream
    api_response = api_instance.get_datasets_tsdfw_stream(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_tsdfw_stream: %s\n" % e)
```
...
# **get_datasets_tudm_settlementdate_settlementdate_settlementperiod_settlementp**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesMiscDatasetRowsTudmDatasetRow get_datasets_tudm_settlementdate_settlementdate_settlementperiod_settlementp(settlement_date, settlement_period, trading_unit_name=trading_unit_name, trading_unit_type=trading_unit_type, format=format)
...
trading_unit_type = 'trading_unit_type_example' # str |  (optional)
format = 'format_example' # str | Response data format. Use json/xml to include metadata. (optional)

try:
    # Trading unit data (S0491_TUDM)
    api_response = api_instance.get_datasets_tudm_settlementdate_settlementdate_settlementperiod_settlementp(settlement_date, settlement_period, trading_unit_name=trading_unit_name, trading_unit_type=trading_unit_type, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_tudm_settlementdate_settlementdate_settlementperiod_settlementp: %s\n" % e)
```
 ...
 **settlement_period** | **int**| Format - int32. | 
 **trading_unit_name** | [**list[str]**](str.md)|  | [optional] 
...
# **get_datasets_tudm_stream_settlementdatefrom_settlementdatefrom_settlementper**
> list[InsightsApiModelsResponsesMiscDatasetRowsTudmDatasetRow] get_datasets_tudm_stream_settlementdatefrom_settlementdatefrom_settlementper(settlement_date_from, settlement_period_from, settlement_date_to, settlement_period_to, trading_unit_name=trading_unit_name, trading_unit_type=trading_unit_type)

Trading unit data (S0491_TUDM) stream

This endpoint provides trading unit data filtered by settlement period, trading unit name and type.    This endpoint has an optimised JSON payload and is aimed at frequent requests for the data.
...
settlement_period_to = 56 # int | Format - int32.
trading_unit_name = ['trading_unit_name_example'] # list[str] |  (optional)
trading_unit_type = 'trading_unit_type_example' # str |  (optional)

try:
    # Trading unit data (S0491_TUDM) stream
    api_response = api_instance.get_datasets_tudm_stream_settlementdatefrom_settlementdatefrom_settlementper(settlement_date_from, settlement_period_from, settlement_date_to, settlement_period_to, trading_unit_name=trading_unit_name, trading_unit_type=trading_unit_type)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_tudm_stream_settlementdatefrom_settlementdatefrom_settlementper: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **settlement_date_from** | **date**| Format - date (as full-date in RFC3339). The settlement date to filter from. This must be in the format yyyy-MM-dd. | 
 **settlement_period_from** | **int**| Format - int32. | 
 **settlement_date_to** | **date**| Format - date (as full-date in RFC3339). The settlement date to filter to. This must be in the format yyyy-MM-dd. | 
 **settlement_period_to** | **int**| Format - int32. | 
 **trading_unit_name** | [**list[str]**](str.md)|  | [optional] 
 **trading_unit_type** | **str**|  | [optional] 

### Return type

[**list[InsightsApiModelsResponsesMiscDatasetRowsTudmDatasetRow]**](InsightsApiModelsResponsesMiscDatasetRowsTudmDatasetRow.md)
...
# **get_datasets_uou2t14d**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesGenerationDatasetRowsAvailabilityByBmUnitDaily get_datasets_uou2t14d(fuel_type=fuel_type, publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, bm_unit=bm_unit, format=format)
...
bm_unit = ['bm_unit_example'] # list[str] | The BM units to query. Add each unit separately. Either the Elexon ID or the National Grid ID can be used.  If no BM unit is supplied all BM units will be returned. (optional)
format = 'format_example' # str | Response data format. Use json/xml to include metadata. (optional)

try:
    # 2 to 14 days ahead generation availability aggregated by Balancing Mechanism Units (UOU2T14D)
    api_response = api_instance.get_datasets_uou2t14d(fuel_type=fuel_type, publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, bm_unit=bm_unit, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_uou2t14d: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **fuel_type** | [**list[str]**](str.md)| The fuel type to query. Add each fuel type separately. If no fuel types are supplied, all fuel types will be returned. | [optional] 
 **publish_date_time_from** | **datetime**| Format - date-time (as date-time in RFC3339). Start of the Publish Time range to query. If specified, PublishDateTimeTo must also be specified.  If both are omitted, latest published data is returned. | [optional] 
 **publish_date_time_to** | **datetime**| Format - date-time (as date-time in RFC3339). End of the Publish Time range to query. If specified, PublishDateTimeFrom must also be specified.  If both are omitted, latest published data is returned. | [optional] 
 **bm_unit** | [**list[str]**](str.md)| The BM units to query. Add each unit separately. Either the Elexon ID or the National Grid ID can be used.  If no BM unit is supplied all BM units will be returned. | [optional] 
 **format** | **str**| Response data format. Use json/xml to include metadata. | [optional] 
...
# **get_datasets_uou2t14d_stream**
> list[InsightsApiModelsResponsesGenerationDatasetRowsAvailabilityByBmUnitDaily] get_datasets_uou2t14d_stream(fuel_type=fuel_type, publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, bm_unit=bm_unit)
...
try:
    # 2 to 14 days ahead generation availability aggregated by Balancing Mechanism Units (UOU2T14D) stream
    api_response = api_instance.get_datasets_uou2t14d_stream(fuel_type=fuel_type, publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, bm_unit=bm_unit)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_uou2t14d_stream: %s\n" % e)
```
...
# **get_datasets_uou2t3yw**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesGenerationDatasetRowsAvailabilityByBmUnitWeekly get_datasets_uou2t3yw(fuel_type=fuel_type, publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, bm_unit=bm_unit, format=format)
...
try:
    # 2 to 156 weeks ahead generation availability aggregated by Balancing Mechanism Units (UOU2T3YW)
    api_response = api_instance.get_datasets_uou2t3yw(fuel_type=fuel_type, publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, bm_unit=bm_unit, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_uou2t3yw: %s\n" % e)
```
...
# **get_datasets_uou2t3yw_stream**
> list[InsightsApiModelsResponsesGenerationDatasetRowsAvailabilityByBmUnitWeekly] get_datasets_uou2t3yw_stream(fuel_type=fuel_type, publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, bm_unit=bm_unit)
...
try:
    # 2 to 156 weeks ahead generation availability aggregated by Balancing Mechanism Units (UOU2T3YW) stream
    api_response = api_instance.get_datasets_uou2t3yw_stream(fuel_type=fuel_type, publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, bm_unit=bm_unit)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_uou2t3yw_stream: %s\n" % e)
```
...
# **get_datasets_watl_publishdatetimefrom_publishdatetimefrom_publishdatetimeto**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesTransparencyDatasetRowsWeekAheadTotalLoadPerBiddingZoneDatasetRow get_datasets_watl_publishdatetimefrom_publishdatetimefrom_publishdatetimeto(publish_date_time_from, publish_date_time_to, format=format)
...
try:
    # Week-Ahead Total Load Forecast Per Bidding Zone (WATL / B0630)
    api_response = api_instance.get_datasets_watl_publishdatetimefrom_publishdatetimefrom_publishdatetimeto(publish_date_time_from, publish_date_time_to, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_watl_publishdatetimefrom_publishdatetimefrom_publishdatetimeto: %s\n" % e)
```
...
# **get_datasets_watl_stream_publishdatetimefrom_publishdatetimefrom_publishdate**
> list[InsightsApiModelsResponsesTransparencyDatasetRowsWeekAheadTotalLoadPerBiddingZoneDatasetRow] get_datasets_watl_stream_publishdatetimefrom_publishdatetimefrom_publishdate(publish_date_time_from, publish_date_time_to)
...
try:
    # Week-Ahead Total Load Forecast Per Bidding Zone (WATL / B0630) stream
    api_response = api_instance.get_datasets_watl_stream_publishdatetimefrom_publishdatetimefrom_publishdate(publish_date_time_from, publish_date_time_to)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_watl_stream_publishdatetimefrom_publishdatetimefrom_publishdate: %s\n" % e)
```
...
# **get_datasets_windfor**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesGenerationDatasetRowsWindGenerationForecast get_datasets_windfor(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, format=format)
...
try:
    # Wind generation forecast (WINDFOR)
    api_response = api_instance.get_datasets_windfor(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_windfor: %s\n" % e)
```
...
# **get_datasets_windfor_stream**
> list[InsightsApiModelsResponsesGenerationDatasetRowsWindGenerationForecast] get_datasets_windfor_stream(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to)

Wind generation forecast (WINDFOR) stream

This endpoint provides wind generation forecast data.    Specific publish time filters may be supplied, otherwise this will retrieve the latest published forecast.    This endpoint has an optimised JSON payload and is aimed at frequent requests for the data.
...
try:
    # Wind generation forecast (WINDFOR) stream
    api_response = api_instance.get_datasets_windfor_stream(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_windfor_stream: %s\n" % e)
```
...
# **get_datasets_yafm_publishdatetimefrom_publishdatetimefrom_publishdatetimeto**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesTransparencyDatasetRowsYearAheadForecastMarginDatasetRow get_datasets_yafm_publishdatetimefrom_publishdatetimefrom_publishdatetimeto(publish_date_time_from, publish_date_time_to, format=format)
...
try:
    # Year Ahead Forecast Margin (YAFM / B0810)
    api_response = api_instance.get_datasets_yafm_publishdatetimefrom_publishdatetimefrom_publishdatetimeto(publish_date_time_from, publish_date_time_to, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_yafm_publishdatetimefrom_publishdatetimefrom_publishdatetimeto: %s\n" % e)
```
...
# **get_datasets_yafm_stream_publishdatetimefrom_publishdatetimefrom_publishdate**
> list[InsightsApiModelsResponsesTransparencyDatasetRowsYearAheadForecastMarginDatasetRow] get_datasets_yafm_stream_publishdatetimefrom_publishdatetimefrom_publishdate(publish_date_time_from, publish_date_time_to)
...
try:
    # Year Ahead Forecast Margin (YAFM / B0810) stream
    api_response = api_instance.get_datasets_yafm_stream_publishdatetimefrom_publishdatetimefrom_publishdate(publish_date_time_from, publish_date_time_to)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_yafm_stream_publishdatetimefrom_publishdatetimefrom_publishdate: %s\n" % e)
```
...
# **get_datasets_yatl_publishdatetimefrom_publishdatetimefrom_publishdatetimeto**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesTransparencyDatasetRowsYearAheadTotalLoadPerBiddingZoneDatasetRow get_datasets_yatl_publishdatetimefrom_publishdatetimefrom_publishdatetimeto(publish_date_time_from, publish_date_time_to, format=format)
...
try:
    # Year-Ahead Total Load Forecast Per Bidding Zone (YATL / B0650)
    api_response = api_instance.get_datasets_yatl_publishdatetimefrom_publishdatetimefrom_publishdatetimeto(publish_date_time_from, publish_date_time_to, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_yatl_publishdatetimefrom_publishdatetimefrom_publishdatetimeto: %s\n" % e)
```
...
# **get_datasets_yatl_stream_publishdatetimefrom_publishdatetimefrom_publishdate**
> list[InsightsApiModelsResponsesTransparencyDatasetRowsYearAheadTotalLoadPerBiddingZoneDatasetRow] get_datasets_yatl_stream_publishdatetimefrom_publishdatetimefrom_publishdate(publish_date_time_from, publish_date_time_to)
...
try:
    # Year-Ahead Total Load Forecast Per Bidding Zone (YATL / B0650) stream
    api_response = api_instance.get_datasets_yatl_stream_publishdatetimefrom_publishdatetimefrom_publishdate(publish_date_time_from, publish_date_time_to)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->get_datasets_yatl_stream_publishdatetimefrom_publishdatetimefrom_publishdate: %s\n" % e)
```
