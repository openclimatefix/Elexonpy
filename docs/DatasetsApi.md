...
[**datasets_dci_get**](DatasetsApi.md#datasets_dci_get) | **GET** /datasets/DCI | Demand control instructions (DCI)
...
try:
    # Disaggregated Balancing Services Adjustment Data (DISBSAD) stream
    api_response = api_instance.datasets_disbsad_stream_get(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_disbsad_stream_get: %s\n" % e)
```
...
# **datasets_feib_get**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesTransparencyDatasetRowsFeibDatasetRow datasets_feib_get(publish_date_time_from, publish_date_time_to, format=format)
...
try:
    # Financial Expenses and Income for Balancing (FEIB / B1790)
    api_response = api_instance.datasets_feib_get(publish_date_time_from, publish_date_time_to, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_feib_get: %s\n" % e)
```
...
# **datasets_feib_stream_get**
> list[InsightsApiModelsResponsesTransparencyDatasetRowsFeibDatasetRow] datasets_feib_stream_get(publish_date_time_from, publish_date_time_to)
...
try:
    # Financial Expenses and Income for Balancing (FEIB / B1790) stream
    api_response = api_instance.datasets_feib_stream_get(publish_date_time_from, publish_date_time_to)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_feib_stream_get: %s\n" % e)
```
...
publish_date = '2013-10-20' # date | The publish date for filtering. This must be in the format yyyy-MM-dd. (optional)
publish_date_time_from = '2013-10-20T19:20:30+01:00' # datetime |  (optional)
publish_date_time_to = '2013-10-20T19:20:30+01:00' # datetime |  (optional)
...
try:
    # 2 to 14 days ahead generation availability aggregated by fuel type (FOU2T14D)
    api_response = api_instance.datasets_fou2_t14_d_get(fuel_type=fuel_type, publish_date=publish_date, publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, bidding_zone=bidding_zone, interconnector=interconnector, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_fou2_t14_d_get: %s\n" % e)
```
 ...
 **publish_date** | **date**| The publish date for filtering. This must be in the format yyyy-MM-dd. | [optional] 
 **publish_date_time_from** | **datetime**|  | [optional] 
 **publish_date_time_to** | **datetime**|  | [optional] 
...
try:
    # 2 to 156 weeks ahead generation availability aggregated by fuel type (FOU2T3YW)
    api_response = api_instance.datasets_fou2_t3_yw_get(fuel_type=fuel_type, publish_date=publish_date, publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, week=week, year=year, bidding_zone=bidding_zone, interconnector=interconnector, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_fou2_t3_yw_get: %s\n" % e)
```
...
# **datasets_freq_get**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesMiscDatasetRowsSystemFrequency datasets_freq_get(measurement_date_time_from=measurement_date_time_from, measurement_date_time_to=measurement_date_time_to, format=format)
...
# create an instance of the API class
api_instance = swagger_client.DatasetsApi()
measurement_date_time_from = '2013-10-20T19:20:30+01:00' # datetime |  (optional)
measurement_date_time_to = '2013-10-20T19:20:30+01:00' # datetime |  (optional)
format = 'format_example' # str | Response data format. Use json/xml to include metadata. (optional)

try:
    # System frequency (FREQ)
    api_response = api_instance.datasets_freq_get(measurement_date_time_from=measurement_date_time_from, measurement_date_time_to=measurement_date_time_to, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_freq_get: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **measurement_date_time_from** | **datetime**|  | [optional] 
 **measurement_date_time_to** | **datetime**|  | [optional] 
 **format** | **str**| Response data format. Use json/xml to include metadata. | [optional] 
...
# **datasets_freq_stream_get**
> list[InsightsApiModelsResponsesMiscDatasetRowsSystemFrequency] datasets_freq_stream_get(measurement_date_time_from=measurement_date_time_from, measurement_date_time_to=measurement_date_time_to)
...
try:
    # System frequency (FREQ) stream
    api_response = api_instance.datasets_freq_stream_get(measurement_date_time_from=measurement_date_time_from, measurement_date_time_to=measurement_date_time_to)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_freq_stream_get: %s\n" % e)
```
...
try:
    # Half-hourly generation outturn by fuel type (FUELHH)
    api_response = api_instance.datasets_fuelhh_get(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, settlement_date_from=settlement_date_from, settlement_date_to=settlement_date_to, settlement_period=settlement_period, fuel_type=fuel_type, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_fuelhh_get: %s\n" % e)
```
...
try:
    # Half-hourly generation outturn by fuel type (FUELHH) stream
    api_response = api_instance.datasets_fuelhh_stream_get(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, settlement_date_from=settlement_date_from, settlement_date_to=settlement_date_to, settlement_period=settlement_period, fuel_type=fuel_type)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_fuelhh_stream_get: %s\n" % e)
```
...
# **datasets_fuelinst_get**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesGenerationDatasetRowsAugmentedOutturnData datasets_fuelinst_get(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, settlement_date_from=settlement_date_from, settlement_date_to=settlement_date_to, settlement_period=settlement_period, fuel_type=fuel_type, format=format)
...
try:
    # Instantaneous generation outturn by fuel type (FUELINST)
    api_response = api_instance.datasets_fuelinst_get(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, settlement_date_from=settlement_date_from, settlement_date_to=settlement_date_to, settlement_period=settlement_period, fuel_type=fuel_type, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_fuelinst_get: %s\n" % e)
```
...
# **datasets_fuelinst_stream_get**
> list[InsightsApiModelsResponsesGenerationDatasetRowsAugmentedOutturnData] datasets_fuelinst_stream_get(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, settlement_date_from=settlement_date_from, settlement_date_to=settlement_date_to, settlement_period=settlement_period, fuel_type=fuel_type)
...
try:
    # Instantaneous generation outturn by fuel type (FUELINST) stream
    api_response = api_instance.datasets_fuelinst_stream_get(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, settlement_date_from=settlement_date_from, settlement_date_to=settlement_date_to, settlement_period=settlement_period, fuel_type=fuel_type)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_fuelinst_stream_get: %s\n" % e)
```
...
# **datasets_igca_get**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesTransparencyDatasetRowsIgcaDatasetRow datasets_igca_get(publish_date_time_from, publish_date_time_to, format=format)
...
try:
    # Installed Generation Capacity Aggregated (IGCA / B1410)
    api_response = api_instance.datasets_igca_get(publish_date_time_from, publish_date_time_to, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_igca_get: %s\n" % e)
```
...
# **datasets_igca_stream_get**
> list[InsightsApiModelsResponsesTransparencyDatasetRowsIgcaDatasetRow] datasets_igca_stream_get(publish_date_time_from, publish_date_time_to)
...
try:
    # Installed Generation Capacity Aggregated (IGCA / B1410) stream
    api_response = api_instance.datasets_igca_stream_get(publish_date_time_from, publish_date_time_to)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_igca_stream_get: %s\n" % e)
```
...
# **datasets_igcpu_get**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesTransparencyDatasetRowsIgcpuDatasetRow datasets_igcpu_get(publish_date_time_from, publish_date_time_to, format=format)
...
try:
    # Installed Generation Capacity per Unit (IGCPU / B1420)
    api_response = api_instance.datasets_igcpu_get(publish_date_time_from, publish_date_time_to, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_igcpu_get: %s\n" % e)
```
...
# **datasets_igcpu_stream_get**
> list[InsightsApiModelsResponsesTransparencyDatasetRowsIgcpuDatasetRow] datasets_igcpu_stream_get(publish_date_time_from, publish_date_time_to)
...
try:
    # Installed Generation Capacity per Unit (IGCPU / B1420) stream
    api_response = api_instance.datasets_igcpu_stream_get(publish_date_time_from, publish_date_time_to)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_igcpu_stream_get: %s\n" % e)
```
...
# **datasets_imbalngc_get**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesIndicatedForecastDatasetRowsIndicatedImbalance datasets_imbalngc_get(boundary=boundary, publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, format=format)
...
try:
    # Day and day-ahead indicated imbalance (IMBALNGC)
    api_response = api_instance.datasets_imbalngc_get(boundary=boundary, publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_imbalngc_get: %s\n" % e)
```
...
# **datasets_imbalngc_stream_get**
> list[InsightsApiModelsResponsesIndicatedForecastDatasetRowsIndicatedImbalance] datasets_imbalngc_stream_get(boundary=boundary, publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to)
...
try:
    # Day and day-ahead indicated imbalance (IMBALNGC) stream
    api_response = api_instance.datasets_imbalngc_stream_get(boundary=boundary, publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_imbalngc_stream_get: %s\n" % e)
```
...
# **datasets_inddem_get**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesIndicatedForecastDatasetRowsIndicatedDemand datasets_inddem_get(boundary=boundary, publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, format=format)
...
try:
    # Day and day-ahead indicated demand (INDDEM)
    api_response = api_instance.datasets_inddem_get(boundary=boundary, publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_inddem_get: %s\n" % e)
```
...
# **datasets_inddem_stream_get**
> list[InsightsApiModelsResponsesIndicatedForecastDatasetRowsIndicatedDemand] datasets_inddem_stream_get(boundary=boundary, publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to)
...
try:
    # Day and day-ahead indicated demand (INDDEM) stream
    api_response = api_instance.datasets_inddem_stream_get(boundary=boundary, publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_inddem_stream_get: %s\n" % e)
```
...
# **datasets_indgen_get**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesIndicatedForecastDatasetRowsIndicatedGeneration datasets_indgen_get(boundary=boundary, publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, format=format)
...
try:
    # Day and day-ahead indicated generation (INDGEN)
    api_response = api_instance.datasets_indgen_get(boundary=boundary, publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_indgen_get: %s\n" % e)
```
...
# **datasets_indgen_stream_get**
> list[InsightsApiModelsResponsesIndicatedForecastDatasetRowsIndicatedGeneration] datasets_indgen_stream_get(boundary=boundary, publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to)
...
try:
    # Day and day-ahead indicated generation (INDGEN) stream
    api_response = api_instance.datasets_indgen_stream_get(boundary=boundary, publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_indgen_stream_get: %s\n" % e)
```
...
# **datasets_indo_get**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesDemandOutturnDatasetRowsDemandOutturnNational datasets_indo_get(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, format=format)
...
try:
    # Initial National Demand outturn (INDO)
    api_response = api_instance.datasets_indo_get(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_indo_get: %s\n" % e)
```
...
# **datasets_indod_get**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesDemandOutturnDatasetRowsIndodDatasetRow datasets_indod_get(publish_date_time_from, publish_date_time_to, format=format)
...
try:
    # Initial National Demand outturn daily (INDOD)
    api_response = api_instance.datasets_indod_get(publish_date_time_from, publish_date_time_to, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_indod_get: %s\n" % e)
```
...
# **datasets_indod_stream_get**
> list[InsightsApiModelsResponsesDemandOutturnDatasetRowsIndodDatasetRow] datasets_indod_stream_get(publish_date_time_from, publish_date_time_to)
...
try:
    # Initial National Demand outturn daily (INDOD) stream
    api_response = api_instance.datasets_indod_stream_get(publish_date_time_from, publish_date_time_to)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_indod_stream_get: %s\n" % e)
```
...
# **datasets_itsdo_get**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesDemandOutturnDatasetRowsDemandOutturnTransmission datasets_itsdo_get(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, format=format)
...
try:
    # Initial Transmission System Demand outturn (ITSDO)
    api_response = api_instance.datasets_itsdo_get(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_itsdo_get: %s\n" % e)
```
...
# **datasets_lolpdrm_get**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesMiscDatasetRowsLossOfLoadProbabilityDeratedMarginData datasets_lolpdrm_get(publish_date_time_from, publish_date_time_to, format=format)
...
try:
    # Loss of load probability and de-rated margin (LOLPDRM)
    api_response = api_instance.datasets_lolpdrm_get(publish_date_time_from, publish_date_time_to, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_lolpdrm_get: %s\n" % e)
```
...
# **datasets_lolpdrm_stream_get**
> list[InsightsApiModelsResponsesMiscDatasetRowsLossOfLoadProbabilityDeratedMarginData] datasets_lolpdrm_stream_get(publish_date_time_from, publish_date_time_to)
...
try:
    # Loss of load probability and de-rated margin (LOLPDRM)
    api_response = api_instance.datasets_lolpdrm_stream_get(publish_date_time_from, publish_date_time_to)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_lolpdrm_stream_get: %s\n" % e)
```
...
# **datasets_matl_get**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesTransparencyDatasetRowsMonthAheadTotalLoadPerBiddingZoneDatasetRow datasets_matl_get(publish_date_time_from, publish_date_time_to, format=format)
...
try:
    # Month-Ahead Total Load Forecast Per Bidding Zone (MATL / B0640)
    api_response = api_instance.datasets_matl_get(publish_date_time_from, publish_date_time_to, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_matl_get: %s\n" % e)
```
...
# **datasets_matl_stream_get**
> list[InsightsApiModelsResponsesTransparencyDatasetRowsMonthAheadTotalLoadPerBiddingZoneDatasetRow] datasets_matl_stream_get(publish_date_time_from, publish_date_time_to)
...
try:
    # Month-Ahead Total Load Forecast Per Bidding Zone (MATL / B0640) stream
    api_response = api_instance.datasets_matl_stream_get(publish_date_time_from, publish_date_time_to)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_matl_stream_get: %s\n" % e)
```
...
# **datasets_mdp_get**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesBalancingDynamicDatasetRowsDeliveryPeriodMaxData datasets_mdp_get(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit, format=format)
...
try:
    # Maximum Delivery Period (MDP)
    api_response = api_instance.datasets_mdp_get(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_mdp_get: %s\n" % e)
```
...
# **datasets_mdp_stream_get**
> list[InsightsApiModelsResponsesBalancingDynamicDatasetRowsDeliveryPeriodMaxData] datasets_mdp_stream_get(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit)
...
try:
    # Maximum Delivery Period (MDP) stream
    api_response = api_instance.datasets_mdp_stream_get(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_mdp_stream_get: %s\n" % e)
```
...
# **datasets_mdv_get**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesBalancingDynamicDatasetRowsDeliveryVolumeMaxData datasets_mdv_get(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit, format=format)
...
try:
    # Maximum Delivery Volume (MDV)
    api_response = api_instance.datasets_mdv_get(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_mdv_get: %s\n" % e)
```
...
# **datasets_mdv_stream_get**
> list[InsightsApiModelsResponsesBalancingDynamicDatasetRowsDeliveryVolumeMaxData] datasets_mdv_stream_get(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit)
...
try:
    # Maximum Delivery Volume (MDV) stream
    api_response = api_instance.datasets_mdv_stream_get(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_mdv_stream_get: %s\n" % e)
```
...
# **datasets_melngc_get**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesIndicatedForecastDatasetRowsIndicatedMargin datasets_melngc_get(boundary=boundary, publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, format=format)
...
try:
    # Day and day-ahead indicated margin (MELNGC)
    api_response = api_instance.datasets_melngc_get(boundary=boundary, publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_melngc_get: %s\n" % e)
```
...
# **datasets_melngc_stream_get**
> list[InsightsApiModelsResponsesIndicatedForecastDatasetRowsIndicatedMargin] datasets_melngc_stream_get(boundary=boundary, publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to)
...
try:
    # Day and day-ahead indicated margin (MELNGC) stream
    api_response = api_instance.datasets_melngc_stream_get(boundary=boundary, publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_melngc_stream_get: %s\n" % e)
```
...
# **datasets_mels_get**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesBalancingPhysicalDatasetRowsDeliveryLimitMaxData datasets_mels_get(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit, format=format)
...
try:
    # Maximum Export Limit (MELS)
    api_response = api_instance.datasets_mels_get(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_mels_get: %s\n" % e)
```
...
# **datasets_mels_stream_get**
> list[InsightsApiModelsResponsesBalancingPhysicalDatasetRowsDeliveryLimitMaxData] datasets_mels_stream_get(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit)
...
try:
    # Maximum Export Limit (MELS) stream
    api_response = api_instance.datasets_mels_stream_get(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_mels_stream_get: %s\n" % e)
```
...
# **datasets_metadata_latest_get**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesReferenceDatasetMetadataLatestRow datasets_metadata_latest_get(format=format)
...
try:
    # Returns the time when each dataset was last updated
    api_response = api_instance.datasets_metadata_latest_get(format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_metadata_latest_get: %s\n" % e)
```
...
# **datasets_mid_get**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesBalancingDatasetRowsMarketIndexDatasetResponse datasets_mid_get(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, data_providers=data_providers, format=format)
...
try:
    # Market Index Data (MID)
    api_response = api_instance.datasets_mid_get(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, data_providers=data_providers, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_mid_get: %s\n" % e)
```
...
# **datasets_mid_stream_get**
> list[InsightsApiModelsResponsesBalancingDatasetRowsMarketIndexDatasetResponse] datasets_mid_stream_get(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, data_providers=data_providers)
...
try:
    # Market Index Data (MID) stream
    api_response = api_instance.datasets_mid_stream_get(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, data_providers=data_providers)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_mid_stream_get: %s\n" % e)
```
...
# **datasets_mils_get**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesBalancingPhysicalDatasetRowsDeliveryLimitMaxData datasets_mils_get(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit, format=format)
...
try:
    # Maximum Import Limit (MILS)
    api_response = api_instance.datasets_mils_get(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_mils_get: %s\n" % e)
```
...
# **datasets_mils_stream_get**
> list[InsightsApiModelsResponsesBalancingPhysicalDatasetRowsDeliveryLimitMaxData] datasets_mils_stream_get(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit)
...
try:
    # Maximum Import Limit (MILS) stream
    api_response = api_instance.datasets_mils_stream_get(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_mils_stream_get: %s\n" % e)
```
...
# **datasets_mnzt_get**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesBalancingDynamicDatasetRowsDeliveryPeriodMinData datasets_mnzt_get(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit, format=format)
...
try:
    # Minimum Non-Zero Time (MNZT)
    api_response = api_instance.datasets_mnzt_get(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_mnzt_get: %s\n" % e)
```
...
# **datasets_mnzt_stream_get**
> list[InsightsApiModelsResponsesBalancingDynamicDatasetRowsDeliveryPeriodMinData] datasets_mnzt_stream_get(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit)
...
try:
    # Minimum Non-Zero Time (MNZT) stream
    api_response = api_instance.datasets_mnzt_stream_get(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_mnzt_stream_get: %s\n" % e)
```
...
# **datasets_mzt_get**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesBalancingDynamicDatasetRowsDeliveryPeriodMinData datasets_mzt_get(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit, format=format)
...
try:
    # Minimum Zero Time (MZT)
    api_response = api_instance.datasets_mzt_get(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_mzt_get: %s\n" % e)
```
...
# **datasets_mzt_stream_get**
> list[InsightsApiModelsResponsesBalancingDynamicDatasetRowsDeliveryPeriodMinData] datasets_mzt_stream_get(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit)
...
try:
    # Minimum Zero Time (MZT) stream
    api_response = api_instance.datasets_mzt_stream_get(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_mzt_stream_get: %s\n" % e)
```
...
# **datasets_ndf_get**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesDemandForecastDatasetRowsDemandForecastNationalDayAhead datasets_ndf_get(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, format=format)
...
try:
    # Day and day-ahead National Demand forecast (NDF)
    api_response = api_instance.datasets_ndf_get(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_ndf_get: %s\n" % e)
```
...
# **datasets_ndf_stream_get**
> list[InsightsApiModelsResponsesDemandForecastDatasetRowsDemandForecastNationalDayAhead] datasets_ndf_stream_get(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to)
...
try:
    # Day and day-ahead National Demand forecast (NDF) stream
    api_response = api_instance.datasets_ndf_stream_get(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_ndf_stream_get: %s\n" % e)
```
...
# **datasets_ndfd_get**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesDemandForecastDatasetRowsDemandForecastNationalDaily datasets_ndfd_get(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, format=format)
...
try:
    # 2-14 days ahead National Demand and surplus forecast (NDFD)
    api_response = api_instance.datasets_ndfd_get(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_ndfd_get: %s\n" % e)
```
...
# **datasets_ndfd_stream_get**
> list[InsightsApiModelsResponsesDemandForecastDatasetRowsDemandForecastNationalDaily] datasets_ndfd_stream_get(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to)
...
try:
    # 2-14 days ahead National Demand and surplus forecast (NDFD) stream
    api_response = api_instance.datasets_ndfd_stream_get(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_ndfd_stream_get: %s\n" % e)
```
...
# **datasets_ndfw_get**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesDemandForecastDatasetRowsDemandForecastNationalWeekly datasets_ndfw_get(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, format=format)
...
try:
    # 2-52 weeks ahead National Demand and surplus forecast (NDFW)
    api_response = api_instance.datasets_ndfw_get(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_ndfw_get: %s\n" % e)
```
...
# **datasets_ndfw_stream_get**
> list[InsightsApiModelsResponsesDemandForecastDatasetRowsDemandForecastNationalWeekly] datasets_ndfw_stream_get(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to)
...
try:
    # 2-52 weeks ahead National Demand and surplus forecast (NDFW) stream
    api_response = api_instance.datasets_ndfw_stream_get(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_ndfw_stream_get: %s\n" % e)
```
...
# **datasets_ndz_get**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesBalancingDynamicDatasetRowsNoticeData datasets_ndz_get(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit, format=format)
...
try:
    # Notice to Deviate from Zero (NDZ)
    api_response = api_instance.datasets_ndz_get(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_ndz_get: %s\n" % e)
```
...
# **datasets_ndz_stream_get**
> list[InsightsApiModelsResponsesBalancingDynamicDatasetRowsNoticeData] datasets_ndz_stream_get(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit)
...
try:
    # Notice to Deviate from Zero (NDZ) stream
    api_response = api_instance.datasets_ndz_stream_get(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_ndz_stream_get: %s\n" % e)
```
...
# **datasets_netbsad_get**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesBalancingDatasetRowsNetBalancingServicesAdjustmentData datasets_netbsad_get(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, format=format)
...
try:
    # Net Balancing Services Adjustment Data (NETBSAD)
    api_response = api_instance.datasets_netbsad_get(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_netbsad_get: %s\n" % e)
```
...
# **datasets_netbsad_stream_get**
> list[InsightsApiModelsResponsesBalancingDatasetRowsNetBalancingServicesAdjustmentData] datasets_netbsad_stream_get(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to)
...
try:
    # Net Balancing Services Adjustment Data (NETBSAD)
    api_response = api_instance.datasets_netbsad_stream_get(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_netbsad_stream_get: %s\n" % e)
```
...
# **datasets_nonbm_get**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesGenerationDatasetRowsNonBmStorData datasets_nonbm_get(_from=_from, to=to, format=format)
...
# create an instance of the API class
api_instance = swagger_client.DatasetsApi()
_from = '2013-10-20T19:20:30+01:00' # datetime | The start of the data publish time window. (optional)
to = '2013-10-20T19:20:30+01:00' # datetime | The end of the data publish time window. (optional)
format = 'format_example' # str | Response data format. Use json/xml to include metadata. (optional)

try:
    # Non-BM STOR (NONBM)
    api_response = api_instance.datasets_nonbm_get(_from=_from, to=to, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_nonbm_get: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **_from** | **datetime**| The start of the data publish time window. | [optional] 
...
# **datasets_nonbm_stream_get**
> list[InsightsApiModelsResponsesGenerationDatasetRowsNonBmStorData] datasets_nonbm_stream_get(_from=_from, to=to)
...
try:
    # Non-BM STOR (NONBM) stream
    api_response = api_instance.datasets_nonbm_stream_get(_from=_from, to=to)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_nonbm_stream_get: %s\n" % e)
```
...
# **datasets_nou2_t14_d_get**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesGenerationDatasetRowsAvailabilityDaily datasets_nou2_t14_d_get(publish_date=publish_date, publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, format=format)
...
try:
    # 2 to 14 days ahead generation availability aggregated data (NOU2T14D)
    api_response = api_instance.datasets_nou2_t14_d_get(publish_date=publish_date, publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_nou2_t14_d_get: %s\n" % e)
```
...
# **datasets_nou2_t3_yw_get**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesGenerationDatasetRowsAvailabilityWeekly datasets_nou2_t3_yw_get(publish_date=publish_date, publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, week=week, year=year, format=format)
...
try:
    # 2 to 156 weeks ahead generation availability aggregated data (NOU2T3YW)
    api_response = api_instance.datasets_nou2_t3_yw_get(publish_date=publish_date, publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, week=week, year=year, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_nou2_t3_yw_get: %s\n" % e)
```
...
# **datasets_ntb_get**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesBalancingDynamicDatasetRowsNoticeData datasets_ntb_get(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit, format=format)
...
try:
    # Notice to Deliver Bids (NTB)
    api_response = api_instance.datasets_ntb_get(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_ntb_get: %s\n" % e)
```
...
# **datasets_ntb_stream_get**
> list[InsightsApiModelsResponsesBalancingDynamicDatasetRowsNoticeData] datasets_ntb_stream_get(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit)
...
try:
    # Notice to Deliver Bids (NTB) stream
    api_response = api_instance.datasets_ntb_stream_get(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_ntb_stream_get: %s\n" % e)
```
...
# **datasets_nto_get**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesBalancingDynamicDatasetRowsNoticeData datasets_nto_get(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit, format=format)
...
try:
    # Notice to Deliver Offers (NTO)
    api_response = api_instance.datasets_nto_get(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_nto_get: %s\n" % e)
```
...
# **datasets_nto_stream_get**
> list[InsightsApiModelsResponsesBalancingDynamicDatasetRowsNoticeData] datasets_nto_stream_get(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit)
...
try:
    # Notice to Deliver Offers (NTO) stream
    api_response = api_instance.datasets_nto_stream_get(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_nto_stream_get: %s\n" % e)
```
...
# **datasets_ocnmf3_y2_get**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesForecastMarginDatasetRowsForecastMarginWeekly datasets_ocnmf3_y2_get(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, format=format)
...
try:
    # 2-156 weeks ahead demand margin forecast (OCNMF3Y2)
    api_response = api_instance.datasets_ocnmf3_y2_get(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_ocnmf3_y2_get: %s\n" % e)
```
...
# **datasets_ocnmf3_y2_stream_get**
> list[InsightsApiModelsResponsesForecastMarginDatasetRowsForecastMarginWeekly] datasets_ocnmf3_y2_stream_get(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to)
...
try:
    # 2-156 weeks ahead demand margin forecast (OCNMF3Y2) stream
    api_response = api_instance.datasets_ocnmf3_y2_stream_get(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_ocnmf3_y2_stream_get: %s\n" % e)
```
...
# **datasets_ocnmf3_y_get**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesForecastSurplusDatasetRowsForecastSurplusWeekly datasets_ocnmf3_y_get(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, format=format)
...
try:
    # 2-156 weeks ahead demand surplus forecast (OCNMF3Y)
    api_response = api_instance.datasets_ocnmf3_y_get(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_ocnmf3_y_get: %s\n" % e)
```
...
# **datasets_ocnmf3_y_stream_get**
> list[InsightsApiModelsResponsesForecastSurplusDatasetRowsForecastSurplusWeekly] datasets_ocnmf3_y_stream_get(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to)
...
try:
    # 2-156 weeks ahead demand surplus forecast (OCNMF3Y) stream
    api_response = api_instance.datasets_ocnmf3_y_stream_get(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_ocnmf3_y_stream_get: %s\n" % e)
```
...
# **datasets_ocnmfd2_get**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesForecastMarginDatasetRowsForecastMarginDaily datasets_ocnmfd2_get(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, format=format)
...
try:
    # 2-14 days ahead demand margin forecast (OCNMFD2)
    api_response = api_instance.datasets_ocnmfd2_get(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_ocnmfd2_get: %s\n" % e)
```
...
# **datasets_ocnmfd2_stream_get**
> list[InsightsApiModelsResponsesForecastMarginDatasetRowsForecastMarginDaily] datasets_ocnmfd2_stream_get(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to)
...
try:
    # 2-14 days ahead demand margin forecast (OCNMFD2) stream
    api_response = api_instance.datasets_ocnmfd2_stream_get(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_ocnmfd2_stream_get: %s\n" % e)
```
...
# **datasets_ocnmfd_get**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesForecastSurplusDatasetRowsForecastSurplusDaily datasets_ocnmfd_get(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, format=format)
...
try:
    # 2-14 days ahead demand surplus forecast (OCNMFD)
    api_response = api_instance.datasets_ocnmfd_get(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_ocnmfd_get: %s\n" % e)
```
...
# **datasets_ocnmfd_stream_get**
> list[InsightsApiModelsResponsesForecastSurplusDatasetRowsForecastSurplusDaily] datasets_ocnmfd_stream_get(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to)
...
try:
    # 2-14 days ahead demand surplus forecast (OCNMFD) stream
    api_response = api_instance.datasets_ocnmfd_stream_get(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_ocnmfd_stream_get: %s\n" % e)
```
...
# **datasets_pbc_get**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesTransparencyDatasetRowsPbcDatasetRow datasets_pbc_get(publish_date_time_from, publish_date_time_to, format=format)
...
try:
    # Procured Balancing Capacity (PBC)
    api_response = api_instance.datasets_pbc_get(publish_date_time_from, publish_date_time_to, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_pbc_get: %s\n" % e)
```
...
# **datasets_pbc_stream_get**
> list[InsightsApiModelsResponsesTransparencyDatasetRowsPbcDatasetRow] datasets_pbc_stream_get(publish_date_time_from, publish_date_time_to)
...
try:
    # Procured Balancing Capacity (PBC) stream
    api_response = api_instance.datasets_pbc_stream_get(publish_date_time_from, publish_date_time_to)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_pbc_stream_get: %s\n" % e)
```
...
# **datasets_pn_get**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesBalancingPhysicalDatasetRowsPhysicalNotificationData datasets_pn_get(settlement_date, settlement_period, bm_unit=bm_unit, format=format)
...
# create an instance of the API class
api_instance = swagger_client.DatasetsApi()
settlement_date = '2013-10-20' # date | The settlement date to query. This must be in the format yyyy-MM-dd.
...
try:
    # Physical Notifications (PN)
    api_response = api_instance.datasets_pn_get(settlement_date, settlement_period, bm_unit=bm_unit, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_pn_get: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **settlement_date** | **date**| The settlement date to query. This must be in the format yyyy-MM-dd. | 
...
# **datasets_pn_stream_get**
> list[InsightsApiModelsResponsesBalancingPhysicalDatasetRowsPhysicalNotificationData] datasets_pn_stream_get(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit)
...
# create an instance of the API class
api_instance = swagger_client.DatasetsApi()
_from = '2013-10-20T19:20:30+01:00' # datetime | The settlement date to query from.
to = '2013-10-20T19:20:30+01:00' # datetime | The settlement date to query up to.
settlement_period_from = 56 # int | The \"from\" settlement period for the filter. This should be an integer from 1-50 inclusive. (optional)
settlement_period_to = 56 # int | The \"to\" settlement period for the filter. This should be an integer from 1-50 inclusive. (optional)
bm_unit = ['bm_unit_example'] # list[str] | The BM units to query. Add each unit separately. If no BM unit is selected all BM units will be displayed. (optional)
...
try:
    # Physical Notifications (PN) stream
    api_response = api_instance.datasets_pn_stream_get(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_pn_stream_get: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **_from** | **datetime**| The settlement date to query from. | 
...
# **datasets_ppbr_get**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesTransparencyDatasetRowsPpbrDatasetRow datasets_ppbr_get(publish_date_time_from, publish_date_time_to, format=format)
...
try:
    # Prices Of Procured Balancing Reserves (PPBR / B1730)
    api_response = api_instance.datasets_ppbr_get(publish_date_time_from, publish_date_time_to, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_ppbr_get: %s\n" % e)
```
...
# **datasets_ppbr_stream_get**
> list[InsightsApiModelsResponsesTransparencyDatasetRowsPpbrDatasetRow] datasets_ppbr_stream_get(publish_date_time_from, publish_date_time_to)
...
try:
    # Prices Of Procured Balancing Reserves (PPBR / B1730) stream
    api_response = api_instance.datasets_ppbr_stream_get(publish_date_time_from, publish_date_time_to)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_ppbr_stream_get: %s\n" % e)
```
...
# **datasets_qas_get**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesBalancingDatasetRowsBalancingServicesVolumeData datasets_qas_get(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit, format=format)
...
try:
    # Balancing Services Volume (QAS)
    api_response = api_instance.datasets_qas_get(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_qas_get: %s\n" % e)
```
...
# **datasets_qas_stream_get**
> list[InsightsApiModelsResponsesBalancingDatasetRowsBalancingServicesVolumeData] datasets_qas_stream_get(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit)
...
try:
    # Balancing Services Volume (QAS) stream
    api_response = api_instance.datasets_qas_stream_get(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_qas_stream_get: %s\n" % e)
```
...
# **datasets_qpn_get**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesBalancingPhysicalDatasetRowsPhysicalNotificationData datasets_qpn_get(settlement_date, settlement_period, bm_unit=bm_unit, format=format)
...
try:
    # Quiescent Physical Notifications (QPN)
    api_response = api_instance.datasets_qpn_get(settlement_date, settlement_period, bm_unit=bm_unit, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_qpn_get: %s\n" % e)
```
...
# **datasets_qpn_stream_get**
> list[InsightsApiModelsResponsesBalancingPhysicalDatasetRowsPhysicalNotificationData] datasets_qpn_stream_get(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit)
...
try:
    # Quiescent Physical Notifications (QPN) stream
    api_response = api_instance.datasets_qpn_stream_get(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_qpn_stream_get: %s\n" % e)
```
...
# **datasets_rdre_get**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesBalancingDynamicRateData datasets_rdre_get(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit, format=format)
...
try:
    # Run Down Rate Export (RDRE)
    api_response = api_instance.datasets_rdre_get(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_rdre_get: %s\n" % e)
```
...
# **datasets_rdre_stream_get**
> list[InsightsApiModelsResponsesBalancingDynamicRateData] datasets_rdre_stream_get(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit)
...
try:
    # Run Down Rate Export (RDRE) stream
    api_response = api_instance.datasets_rdre_stream_get(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_rdre_stream_get: %s\n" % e)
```
...
# **datasets_rdri_get**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesBalancingDynamicRateData datasets_rdri_get(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit, format=format)
...
try:
    # Run Down Rate Import (RDRI)
    api_response = api_instance.datasets_rdri_get(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_rdri_get: %s\n" % e)
```
...
# **datasets_rdri_stream_get**
> list[InsightsApiModelsResponsesBalancingDynamicRateData] datasets_rdri_stream_get(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit)
...
try:
    # Run Down Rate Import (RDRI) stream
    api_response = api_instance.datasets_rdri_stream_get(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_rdri_stream_get: %s\n" % e)
```
...
# **datasets_remit_get**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesTransparencyRemitDatasetRowsRemitMessage datasets_remit_get(publish_date_time_from, publish_date_time_to, format=format)
...
try:
    # The Regulation on Wholesale Energy Markets Integrity and Transparency (REMIT)
    api_response = api_instance.datasets_remit_get(publish_date_time_from, publish_date_time_to, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_remit_get: %s\n" % e)
```
...
# **datasets_remit_stream_get**
> list[InsightsApiModelsResponsesTransparencyRemitDatasetRowsRemitMessage] datasets_remit_stream_get(publish_date_time_from, publish_date_time_to)
...
try:
    # The Regulation on Wholesale Energy Markets Integrity and Transparency (REMIT) stream
    api_response = api_instance.datasets_remit_stream_get(publish_date_time_from, publish_date_time_to)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_remit_stream_get: %s\n" % e)
```
...
# **datasets_rure_get**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesBalancingDynamicRateData datasets_rure_get(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit, format=format)
...
try:
    # Run Up Rate Export (RURE)
    api_response = api_instance.datasets_rure_get(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_rure_get: %s\n" % e)
```
...
# **datasets_rure_stream_get**
> list[InsightsApiModelsResponsesBalancingDynamicRateData] datasets_rure_stream_get(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit)
...
try:
    # Run Up Rate Export (RURE) stream
    api_response = api_instance.datasets_rure_stream_get(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_rure_stream_get: %s\n" % e)
```
...
# **datasets_ruri_get**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesBalancingDynamicRateData datasets_ruri_get(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit, format=format)
...
try:
    # Run Up Rate Import (RURI)
    api_response = api_instance.datasets_ruri_get(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_ruri_get: %s\n" % e)
```
...
# **datasets_ruri_stream_get**
> list[InsightsApiModelsResponsesBalancingDynamicRateData] datasets_ruri_stream_get(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit)
...
try:
    # Run Up Rate Import (RURI) stream
    api_response = api_instance.datasets_ruri_stream_get(_from, to, settlement_period_from=settlement_period_from, settlement_period_to=settlement_period_to, bm_unit=bm_unit)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_ruri_stream_get: %s\n" % e)
```
...
# **datasets_sel_get**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesBalancingDynamicDatasetRowsStablePortageLimitData datasets_sel_get(_from=_from, to=to, bm_unit=bm_unit, format=format)
...
# create an instance of the API class
api_instance = swagger_client.DatasetsApi()
_from = '2013-10-20T19:20:30+01:00' # datetime | The start of the data time window. (optional)
to = '2013-10-20T19:20:30+01:00' # datetime | The end of the data time window. (optional)
bm_unit = ['bm_unit_example'] # list[str] | The BM units to query. Add each unit separately. If no BM unit is selected all BM units will be displayed. (optional)
format = 'format_example' # str | Response data format. Use json/xml to include metadata. (optional)

try:
    # Stable Export Limit (SEL)
    api_response = api_instance.datasets_sel_get(_from=_from, to=to, bm_unit=bm_unit, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_sel_get: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **_from** | **datetime**| The start of the data time window. | [optional] 
...
# **datasets_sel_stream_get**
> list[InsightsApiModelsResponsesBalancingDynamicDatasetRowsStablePortageLimitData] datasets_sel_stream_get(_from=_from, to=to, bm_unit=bm_unit)
...
try:
    # Stable Export Limit (SEL) stream
    api_response = api_instance.datasets_sel_stream_get(_from=_from, to=to, bm_unit=bm_unit)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_sel_stream_get: %s\n" % e)
```
...
# **datasets_sil_get**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesBalancingDynamicDatasetRowsStablePortageLimitData datasets_sil_get(_from=_from, to=to, bm_unit=bm_unit, format=format)
...
try:
    # Stable Import Limit (SIL)
    api_response = api_instance.datasets_sil_get(_from=_from, to=to, bm_unit=bm_unit, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_sil_get: %s\n" % e)
```
...
# **datasets_sil_stream_get**
> list[InsightsApiModelsResponsesBalancingDynamicDatasetRowsStablePortageLimitData] datasets_sil_stream_get(_from=_from, to=to, bm_unit=bm_unit)
...
try:
    # Stable Import Limit (SIL) stream
    api_response = api_instance.datasets_sil_stream_get(_from=_from, to=to, bm_unit=bm_unit)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_sil_stream_get: %s\n" % e)
```
...
# **datasets_soso_get**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesMiscDatasetRowsSoSoPricesDatasetRow datasets_soso_get(publish_date_time_from, publish_date_time_to, format=format)
...
try:
    # SO-SO prices (SOSO)
    api_response = api_instance.datasets_soso_get(publish_date_time_from, publish_date_time_to, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_soso_get: %s\n" % e)
```
...
# **datasets_soso_stream_get**
> list[InsightsApiModelsResponsesMiscDatasetRowsSoSoPricesDatasetRow] datasets_soso_stream_get(publish_date_time_from, publish_date_time_to)
...
try:
    # SO-SO prices (SOSO) stream
    api_response = api_instance.datasets_soso_stream_get(publish_date_time_from, publish_date_time_to)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_soso_stream_get: %s\n" % e)
```
...
# **datasets_syswarn_get**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesMiscDatasetRowsSystemWarningsData datasets_syswarn_get(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, format=format)
...
try:
    # System warnings (SYSWARN)
    api_response = api_instance.datasets_syswarn_get(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_syswarn_get: %s\n" % e)
```
...
# **datasets_syswarn_stream_get**
> list[InsightsApiModelsResponsesMiscDatasetRowsSystemWarningsData] datasets_syswarn_stream_get(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to)
...
try:
    # System warnings (SYSWARN) stream
    api_response = api_instance.datasets_syswarn_stream_get(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_syswarn_stream_get: %s\n" % e)
```
...
# **datasets_temp_get**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesMiscDatasetRowsTemperatureData datasets_temp_get(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, format=format)
...
try:
    # Temperature data (TEMP)
    api_response = api_instance.datasets_temp_get(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_temp_get: %s\n" % e)
```
...
# **datasets_tsdf_get**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesDemandForecastDatasetRowsDemandForecastTransmissionDayAhead datasets_tsdf_get(boundary=boundary, publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, format=format)
...
try:
    # Day and day-ahead Transmission System Demand forecast (TSDF)
    api_response = api_instance.datasets_tsdf_get(boundary=boundary, publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_tsdf_get: %s\n" % e)
```
...
# **datasets_tsdf_stream_get**
> list[InsightsApiModelsResponsesDemandForecastDatasetRowsDemandForecastTransmissionDayAhead] datasets_tsdf_stream_get(boundary=boundary, publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to)
...
try:
    # Day and day-ahead Transmission System Demand forecast (TSDF) stream
    api_response = api_instance.datasets_tsdf_stream_get(boundary=boundary, publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_tsdf_stream_get: %s\n" % e)
```
...
# **datasets_tsdfd_get**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesDemandForecastDatasetRowsDemandForecastTransmissionDaily datasets_tsdfd_get(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, format=format)
...
try:
    # 2-14 days ahead Transmission System Demand and surplus forecast (TSDFD)
    api_response = api_instance.datasets_tsdfd_get(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_tsdfd_get: %s\n" % e)
```
...
# **datasets_tsdfd_stream_get**
> list[InsightsApiModelsResponsesDemandForecastDatasetRowsDemandForecastTransmissionDaily] datasets_tsdfd_stream_get(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to)
...
try:
    # 2-14 days ahead Transmission System Demand and surplus forecast (TSDFD) stream
    api_response = api_instance.datasets_tsdfd_stream_get(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_tsdfd_stream_get: %s\n" % e)
```
...
# **datasets_tsdfw_get**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesDemandForecastDatasetRowsDemandForecastTransmissionWeekly datasets_tsdfw_get(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, format=format)
...
try:
    # 2-52 weeks ahead Transmission System Demand and surplus forecast (TSDFW)
    api_response = api_instance.datasets_tsdfw_get(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_tsdfw_get: %s\n" % e)
```
...
# **datasets_tsdfw_stream_get**
> list[InsightsApiModelsResponsesDemandForecastDatasetRowsDemandForecastTransmissionWeekly] datasets_tsdfw_stream_get(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to)
...
try:
    # 2-52 weeks ahead Transmission System Demand and surplus forecast (TSDFW) stream
    api_response = api_instance.datasets_tsdfw_stream_get(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_tsdfw_stream_get: %s\n" % e)
```
...
# **datasets_tudm_get**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesMiscDatasetRowsTudmDatasetRow datasets_tudm_get(settlement_date, settlement_period, trading_unit_name=trading_unit_name, trading_unit_type=trading_unit_type, format=format)
...
try:
    # Trading unit data (S0491_TUDM)
    api_response = api_instance.datasets_tudm_get(settlement_date, settlement_period, trading_unit_name=trading_unit_name, trading_unit_type=trading_unit_type, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_tudm_get: %s\n" % e)
```
...
# **datasets_tudm_stream_get**
> list[InsightsApiModelsResponsesMiscDatasetRowsTudmDatasetRow] datasets_tudm_stream_get(settlement_date_from, settlement_period_from, settlement_date_to, settlement_period_to, trading_unit_name=trading_unit_name, trading_unit_type=trading_unit_type)
...
# create an instance of the API class
api_instance = swagger_client.DatasetsApi()
settlement_date_from = '2013-10-20' # date | The settlement date to filter from. This must be in the format yyyy-MM-dd.
settlement_period_from = 56 # int | 
settlement_date_to = '2013-10-20' # date | The settlement date to filter to. This must be in the format yyyy-MM-dd.
settlement_period_to = 56 # int | 
trading_unit_name = ['trading_unit_name_example'] # list[str] |  (optional)
trading_unit_type = 'trading_unit_type_example' # str |  (optional)

try:
    # Trading unit data (S0491_TUDM) stream
    api_response = api_instance.datasets_tudm_stream_get(settlement_date_from, settlement_period_from, settlement_date_to, settlement_period_to, trading_unit_name=trading_unit_name, trading_unit_type=trading_unit_type)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_tudm_stream_get: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **settlement_date_from** | **date**| The settlement date to filter from. This must be in the format yyyy-MM-dd. | 
 **settlement_period_from** | **int**|  | 
 **settlement_date_to** | **date**| The settlement date to filter to. This must be in the format yyyy-MM-dd. | 
...
# **datasets_uou2_t14_d_get**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesGenerationDatasetRowsAvailabilityByBmUnitDaily datasets_uou2_t14_d_get(fuel_type=fuel_type, publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, bm_unit=bm_unit, format=format)
...
publish_date_time_from = '2013-10-20T19:20:30+01:00' # datetime | Start of the Publish Time range to query. If specified, PublishDateTimeTo must also be specified.  If both are omitted, latest published data is returned. (optional)
publish_date_time_to = '2013-10-20T19:20:30+01:00' # datetime | End of the Publish Time range to query. If specified, PublishDateTimeFrom must also be specified.  If both are omitted, latest published data is returned. (optional)
...
try:
    # 2 to 14 days ahead generation availability aggregated by Balancing Mechanism Units (UOU2T14D)
    api_response = api_instance.datasets_uou2_t14_d_get(fuel_type=fuel_type, publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, bm_unit=bm_unit, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_uou2_t14_d_get: %s\n" % e)
```
 ...
 **publish_date_time_from** | **datetime**| Start of the Publish Time range to query. If specified, PublishDateTimeTo must also be specified.  If both are omitted, latest published data is returned. | [optional] 
 **publish_date_time_to** | **datetime**| End of the Publish Time range to query. If specified, PublishDateTimeFrom must also be specified.  If both are omitted, latest published data is returned. | [optional] 
...
# **datasets_uou2_t14_d_stream_get**
> list[InsightsApiModelsResponsesGenerationDatasetRowsAvailabilityByBmUnitDaily] datasets_uou2_t14_d_stream_get(fuel_type=fuel_type, publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, bm_unit=bm_unit)
...
try:
    # 2 to 14 days ahead generation availability aggregated by Balancing Mechanism Units (UOU2T14D) stream
    api_response = api_instance.datasets_uou2_t14_d_stream_get(fuel_type=fuel_type, publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, bm_unit=bm_unit)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_uou2_t14_d_stream_get: %s\n" % e)
```
...
# **datasets_uou2_t3_yw_get**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesGenerationDatasetRowsAvailabilityByBmUnitWeekly datasets_uou2_t3_yw_get(fuel_type=fuel_type, publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, bm_unit=bm_unit, format=format)
...
try:
    # 2 to 156 weeks ahead generation availability aggregated by Balancing Mechanism Units (UOU2T3YW)
    api_response = api_instance.datasets_uou2_t3_yw_get(fuel_type=fuel_type, publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, bm_unit=bm_unit, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_uou2_t3_yw_get: %s\n" % e)
```
...
# **datasets_uou2_t3_yw_stream_get**
> list[InsightsApiModelsResponsesGenerationDatasetRowsAvailabilityByBmUnitWeekly] datasets_uou2_t3_yw_stream_get(fuel_type=fuel_type, publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, bm_unit=bm_unit)
...
try:
    # 2 to 156 weeks ahead generation availability aggregated by Balancing Mechanism Units (UOU2T3YW) stream
    api_response = api_instance.datasets_uou2_t3_yw_stream_get(fuel_type=fuel_type, publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, bm_unit=bm_unit)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_uou2_t3_yw_stream_get: %s\n" % e)
```
...
# **datasets_watl_get**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesTransparencyDatasetRowsWeekAheadTotalLoadPerBiddingZoneDatasetRow datasets_watl_get(publish_date_time_from, publish_date_time_to, format=format)
...
try:
    # Week-Ahead Total Load Forecast Per Bidding Zone (WATL / B0630)
    api_response = api_instance.datasets_watl_get(publish_date_time_from, publish_date_time_to, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_watl_get: %s\n" % e)
```
...
# **datasets_watl_stream_get**
> list[InsightsApiModelsResponsesTransparencyDatasetRowsWeekAheadTotalLoadPerBiddingZoneDatasetRow] datasets_watl_stream_get(publish_date_time_from, publish_date_time_to)
...
try:
    # Week-Ahead Total Load Forecast Per Bidding Zone (WATL / B0630) stream
    api_response = api_instance.datasets_watl_stream_get(publish_date_time_from, publish_date_time_to)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_watl_stream_get: %s\n" % e)
```
...
# **datasets_windfor_get**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesGenerationDatasetRowsWindGenerationForecast datasets_windfor_get(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, format=format)
...
try:
    # Wind generation forecast (WINDFOR)
    api_response = api_instance.datasets_windfor_get(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_windfor_get: %s\n" % e)
```
...
# **datasets_windfor_stream_get**
> list[InsightsApiModelsResponsesGenerationDatasetRowsWindGenerationForecast] datasets_windfor_stream_get(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to)
...
try:
    # Wind generation forecast (WINDFOR) stream
    api_response = api_instance.datasets_windfor_stream_get(publish_date_time_from=publish_date_time_from, publish_date_time_to=publish_date_time_to)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_windfor_stream_get: %s\n" % e)
```
...
# **datasets_yafm_get**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesTransparencyDatasetRowsYearAheadForecastMarginDatasetRow datasets_yafm_get(publish_date_time_from, publish_date_time_to, format=format)
...
try:
    # Year Ahead Forecast Margin (YAFM / B0810)
    api_response = api_instance.datasets_yafm_get(publish_date_time_from, publish_date_time_to, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_yafm_get: %s\n" % e)
```
...
# **datasets_yafm_stream_get**
> list[InsightsApiModelsResponsesTransparencyDatasetRowsYearAheadForecastMarginDatasetRow] datasets_yafm_stream_get(publish_date_time_from, publish_date_time_to)
...
try:
    # Year Ahead Forecast Margin (YAFM / B0810) stream
    api_response = api_instance.datasets_yafm_stream_get(publish_date_time_from, publish_date_time_to)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_yafm_stream_get: %s\n" % e)
```
...
# **datasets_yatl_get**
> InsightsApiModelsResponsesDatasetResponse1InsightsApiModelsResponsesTransparencyDatasetRowsYearAheadTotalLoadPerBiddingZoneDatasetRow datasets_yatl_get(publish_date_time_from, publish_date_time_to, format=format)
...
try:
    # Year-Ahead Total Load Forecast Per Bidding Zone (YATL / B0650)
    api_response = api_instance.datasets_yatl_get(publish_date_time_from, publish_date_time_to, format=format)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_yatl_get: %s\n" % e)
```
...
# **datasets_yatl_stream_get**
> list[InsightsApiModelsResponsesTransparencyDatasetRowsYearAheadTotalLoadPerBiddingZoneDatasetRow] datasets_yatl_stream_get(publish_date_time_from, publish_date_time_to)
...
try:
    # Year-Ahead Total Load Forecast Per Bidding Zone (YATL / B0650) stream
    api_response = api_instance.datasets_yatl_stream_get(publish_date_time_from, publish_date_time_to)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DatasetsApi->datasets_yatl_stream_get: %s\n" % e)
```
